...
echo "install mcc-lidar 2.1.0"  x
echo "--------------------------------------------"
./bash/mcc-lidar.sh

echo "install crunch 104"  x
echo "--------------------------------------------"
./bash/crunch.sh
...
echo "install gdal 3.10.0"  x
echo "--------------------------------------------"
./bash/gdal.sh

echo "install pdal 2.5.3#1"  x
echo "--------------------------------------------"
./bash/pdal.sh

echo "install Qt5 5.15.15"  x
echo "--------------------------------------------"
./bash/qt5.sh
...
echo "install pcl 1.14.1#3"  x
echo "--------------------------------------------"
./bash/pcl.sh

echo "install opencv4 4.8.0#14"  x
echo "--------------------------------------------"
./bash/opencv4.sh

echo "install osg 3.6.5#25"  x
echo "--------------------------------------------"
./bash/osg.sh

echo "install osg-qt Qt5#3"  x
echo "--------------------------------------------"
./bash/osg-qt.sh
