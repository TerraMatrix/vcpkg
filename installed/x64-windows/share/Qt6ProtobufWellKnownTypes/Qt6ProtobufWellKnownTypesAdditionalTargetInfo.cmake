...
get_target_property(_qt_imported_location Qt6::ProtobufWellKnownTypes IMPORTED_LOCATION_RELEASE)
get_target_property(_qt_imported_implib Qt6::ProtobufWellKnownTypes IMPORTED_IMPLIB_RELEASE)
get_target_property(_qt_imported_link_dependencies Qt6::ProtobufWellKnownTypes IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE)
...
if(_qt_imported_location)
    set_property(TARGET Qt6::ProtobufWellKnownTypes PROPERTY IMPORTED_LOCATION_RELWITHDEBINFO "${_qt_imported_location}")
endif()
if(_qt_imported_implib)
    set_property(TARGET Qt6::ProtobufWellKnownTypes PROPERTY IMPORTED_IMPLIB_RELWITHDEBINFO "${_qt_imported_implib}")
endif()
if(_qt_imported_link_dependencies)
    set_property(TARGET Qt6::ProtobufWellKnownTypes PROPERTY IMPORTED_LINK_DEPENDENT_LIBRARIES_RELWITHDEBINFO "${_qt_imported_link_dependencies}")
endif()
...
get_target_property(_qt_imported_objects Qt6::ProtobufWellKnownTypes_qtprotoreg IMPORTED_OBJECTS_RELEASE)
get_target_property(_qt_imported_clr Qt6::ProtobufWellKnownTypes_qtprotoreg IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE)
...
# Import target "Qt6::ProtobufWellKnownTypes_qtprotoreg" for configuration "RelWithDebInfo"
set_property(TARGET Qt6::ProtobufWellKnownTypes_qtprotoreg APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)

if(_qt_imported_objects)
    set_property(TARGET Qt6::ProtobufWellKnownTypes_qtprotoreg PROPERTY IMPORTED_OBJECTS_RELWITHDEBINFO "${_qt_imported_objects}")
endif()
if(_qt_imported_clr)
    set_property(TARGET Qt6::ProtobufWellKnownTypes_qtprotoreg PROPERTY IMPORTED_COMMON_LANGUAGE_RUNTIME_RELWITHDEBINFO "${_qt_imported_clr}")
endif()
