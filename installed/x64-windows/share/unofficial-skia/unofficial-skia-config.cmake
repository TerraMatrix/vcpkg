if(NOT COMMAND z_vcpkg_skia_get_link_libraries)
    function(z_vcpkg_skia_get_link_libraries out_var type libraries)
        set(libs "")
        if(type STREQUAL "DEBUG")
            set(vcpkg_link_directories "${z_vcpkg_skia_root}/debug/lib" "${z_vcpkg_skia_root}/lib")
        else()
            set(vcpkg_link_directories "${z_vcpkg_skia_root}/lib" "${z_vcpkg_skia_root}/debug/lib")
        endif()
...
get_filename_component(z_vcpkg_skia_root "${CMAKE_CURRENT_LIST_DIR}" PATH)
