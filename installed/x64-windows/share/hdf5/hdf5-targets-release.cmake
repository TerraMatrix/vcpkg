...
# Import target "hdf5::ph5diff" for configuration "Release"
set_property(TARGET hdf5::ph5diff APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(hdf5::ph5diff PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/hdf5/ph5diff.exe"
  )
...
# Import target "hdf5::h5perf" for configuration "Release"
set_property(TARGET hdf5::h5perf APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(hdf5::h5perf PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/hdf5/h5perf.exe"
  )
...
set_target_properties(hdf5::gif2h5 PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/hdf5/gif2h5.exe"
  )
...
set_target_properties(hdf5::h52gif PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/hdf5/h52gif.exe"
  )
...
set_target_properties(hdf5::h5watch PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/hdf5/h5watch.exe"
  )
