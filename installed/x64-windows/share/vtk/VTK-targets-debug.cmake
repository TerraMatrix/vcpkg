...
set_target_properties(VTK::ParallelMPI PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/debug/lib/vtkParallelMPI-9.3d.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "VTK::CommonDataModel"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/bin/vtkParallelMPI-9.3d.dll"
  )

list(APPEND _cmake_import_check_targets VTK::ParallelMPI )
list(APPEND _cmake_import_check_files_for_VTK::ParallelMPI "${_IMPORT_PREFIX}/debug/lib/vtkParallelMPI-9.3d.lib" "${_IMPORT_PREFIX}/debug/bin/vtkParallelMPI-9.3d.dll" )
...
set_target_properties(VTK::GUISupportQt PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/debug/lib/vtkGUISupportQt-9.3d.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "VTK::CommonDataModel;VTK::CommonSystem;VTK::FiltersExtraction;VTK::InteractionStyle"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/bin/vtkGUISupportQt-9.3d.dll"
  )

list(APPEND _cmake_import_check_targets VTK::GUISupportQt )
list(APPEND _cmake_import_check_files_for_VTK::GUISupportQt "${_IMPORT_PREFIX}/debug/lib/vtkGUISupportQt-9.3d.lib" "${_IMPORT_PREFIX}/debug/bin/vtkGUISupportQt-9.3d.dll" )
...
set_target_properties(VTK::ViewsQt PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/debug/lib/vtkViewsQt-9.3d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/bin/vtkViewsQt-9.3d.dll"
  )

list(APPEND _cmake_import_check_targets VTK::ViewsQt )
list(APPEND _cmake_import_check_files_for_VTK::ViewsQt "${_IMPORT_PREFIX}/debug/lib/vtkViewsQt-9.3d.lib" "${_IMPORT_PREFIX}/debug/bin/vtkViewsQt-9.3d.dll" )
...
set_target_properties(VTK::RenderingQt PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/debug/lib/vtkRenderingQt-9.3d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/bin/vtkRenderingQt-9.3d.dll"
  )

list(APPEND _cmake_import_check_targets VTK::RenderingQt )
list(APPEND _cmake_import_check_files_for_VTK::RenderingQt "${_IMPORT_PREFIX}/debug/lib/vtkRenderingQt-9.3d.lib" "${_IMPORT_PREFIX}/debug/bin/vtkRenderingQt-9.3d.dll" )
...
set_target_properties(VTK::IOIOSS PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "VTK::FiltersCore;VTK::FiltersExtraction;VTK::ParallelMPI"
...
set_target_properties(VTK::RenderingGL2PSOpenGL2 PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "VTK::CommonCore;VTK::CommonDataModel;VTK::CommonMath;VTK::RenderingCore"
...
set_target_properties(VTK::IOExportGL2PS PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "VTK::CommonCore;VTK::CommonDataModel;VTK::ImagingCore;VTK::RenderingCore"
...
set_target_properties(VTK::GUISupportQtSQL PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/debug/lib/vtkGUISupportQtSQL-9.3d.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "VTK::vtksys"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/bin/vtkGUISupportQtSQL-9.3d.dll"
  )

list(APPEND _cmake_import_check_targets VTK::GUISupportQtSQL )
list(APPEND _cmake_import_check_files_for_VTK::GUISupportQtSQL "${_IMPORT_PREFIX}/debug/lib/vtkGUISupportQtSQL-9.3d.lib" "${_IMPORT_PREFIX}/debug/bin/vtkGUISupportQtSQL-9.3d.dll" )
...
set_target_properties(VTK::GUISupportQtQuick PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/debug/lib/vtkGUISupportQtQuick-9.3d.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/bin/vtkGUISupportQtQuick-9.3d.dll"
  )

list(APPEND _cmake_import_check_targets VTK::GUISupportQtQuick )
list(APPEND _cmake_import_check_files_for_VTK::GUISupportQtQuick "${_IMPORT_PREFIX}/debug/lib/vtkGUISupportQtQuick-9.3d.lib" "${_IMPORT_PREFIX}/debug/bin/vtkGUISupportQtQuick-9.3d.dll" )
...
set_target_properties(VTK::qmlvtkplugin PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/qml/VTK.9.3/qmlvtkplugin.dll"
  )

list(APPEND _cmake_import_check_targets VTK::qmlvtkplugin )
list(APPEND _cmake_import_check_files_for_VTK::qmlvtkplugin "${_IMPORT_PREFIX}/qml/VTK.9.3/qmlvtkplugin.dll" )
...
set_target_properties(VTK::FiltersParallelDIY2 PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "VTK::CommonCore;VTK::CommonDataModel;VTK::CommonExecutionModel;VTK::ImagingCore;VTK::IOXML;VTK::ParallelCore;VTK::ParallelMPI"
