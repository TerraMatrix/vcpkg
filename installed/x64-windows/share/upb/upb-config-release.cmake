...
list(APPEND _cmake_import_check_files_for_upb::upb "${_IMPORT_PREFIX}/lib/upb.lib" )
...
set_target_properties(upb::utf8_range PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/upb_utf8_range.lib"
  )

list(APPEND _cmake_import_check_targets upb::utf8_range )
list(APPEND _cmake_import_check_files_for_upb::utf8_range "${_IMPORT_PREFIX}/lib/upb_utf8_range.lib" )
...
list(APPEND _cmake_import_check_files_for_upb::fastdecode "${_IMPORT_PREFIX}/lib/upb_fastdecode.lib" )
...
list(APPEND _cmake_import_check_files_for_upb::json "${_IMPORT_PREFIX}/lib/upb_json.lib" )
...
set_target_properties(upb::descriptor_upb_proto PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/descriptor_upb_proto.lib"
  )

list(APPEND _cmake_import_check_targets upb::descriptor_upb_proto )
list(APPEND _cmake_import_check_files_for_upb::descriptor_upb_proto "${_IMPORT_PREFIX}/lib/descriptor_upb_proto.lib" )
...
list(APPEND _cmake_import_check_files_for_upb::reflection "${_IMPORT_PREFIX}/lib/upb_reflection.lib" )
...
list(APPEND _cmake_import_check_files_for_upb::textformat "${_IMPORT_PREFIX}/lib/upb_textformat.lib" )
...
set_target_properties(upb::mini_table PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/upb_mini_table.lib"
  )

list(APPEND _cmake_import_check_targets upb::mini_table )
list(APPEND _cmake_import_check_files_for_upb::mini_table "${_IMPORT_PREFIX}/lib/upb_mini_table.lib" )
...
set_target_properties(upb::extension_registry PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/upb_extension_registry.lib"
  )

list(APPEND _cmake_import_check_targets upb::extension_registry )
list(APPEND _cmake_import_check_files_for_upb::extension_registry "${_IMPORT_PREFIX}/lib/upb_extension_registry.lib" )
...
set_target_properties(upb::collections PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/upb_collections.lib"
  )

list(APPEND _cmake_import_check_targets upb::collections )
list(APPEND _cmake_import_check_files_for_upb::collections "${_IMPORT_PREFIX}/lib/upb_collections.lib" )
...
set_target_properties(upb::protoc-gen-upb PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/upb/protoc-gen-upb.exe"
  )
...
set_target_properties(upb::protoc-gen-upbdefs PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/upb/protoc-gen-upbdefs.exe"
  )
