...
set_target_properties(VTKCompileTools::WrappingTools PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkWrappingTools_CompileTools-9.3.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkWrappingTools_CompileTools-9.3.dll"
  )

list(APPEND _cmake_import_check_targets VTKCompileTools::WrappingTools )
list(APPEND _cmake_import_check_files_for_VTKCompileTools::WrappingTools "${_IMPORT_PREFIX}/lib/vtkWrappingTools_CompileTools-9.3.lib" "${_IMPORT_PREFIX}/bin/vtkWrappingTools_CompileTools-9.3.dll" )
...
set_target_properties(VTKCompileTools::WrapHierarchy PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/vtk-compile-tools/vtkWrapHierarchy-9.3.exe"
  )

list(APPEND _cmake_import_check_targets VTKCompileTools::WrapHierarchy )
list(APPEND _cmake_import_check_files_for_VTKCompileTools::WrapHierarchy "${_IMPORT_PREFIX}/tools/vtk-compile-tools/vtkWrapHierarchy-9.3.exe" )
...
set_target_properties(VTKCompileTools::WrapPython PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/vtk-compile-tools/vtkWrapPython-9.3.exe"
  )

list(APPEND _cmake_import_check_targets VTKCompileTools::WrapPython )
list(APPEND _cmake_import_check_files_for_VTKCompileTools::WrapPython "${_IMPORT_PREFIX}/tools/vtk-compile-tools/vtkWrapPython-9.3.exe" )
...
set_target_properties(VTKCompileTools::WrapPythonInit PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/vtk-compile-tools/vtkWrapPythonInit-9.3.exe"
  )

list(APPEND _cmake_import_check_targets VTKCompileTools::WrapPythonInit )
list(APPEND _cmake_import_check_files_for_VTKCompileTools::WrapPythonInit "${_IMPORT_PREFIX}/tools/vtk-compile-tools/vtkWrapPythonInit-9.3.exe" )
...
set_target_properties(VTKCompileTools::ParseJava PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/vtk-compile-tools/vtkParseJava-9.3.exe"
  )

list(APPEND _cmake_import_check_targets VTKCompileTools::ParseJava )
list(APPEND _cmake_import_check_files_for_VTKCompileTools::ParseJava "${_IMPORT_PREFIX}/tools/vtk-compile-tools/vtkParseJava-9.3.exe" )
...
set_target_properties(VTKCompileTools::WrapJava PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/vtk-compile-tools/vtkWrapJava-9.3.exe"
  )

list(APPEND _cmake_import_check_targets VTKCompileTools::WrapJava )
list(APPEND _cmake_import_check_files_for_VTKCompileTools::WrapJava "${_IMPORT_PREFIX}/tools/vtk-compile-tools/vtkWrapJava-9.3.exe" )
