...
macro(_populate_SerialBus_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG") # 1
        set(imported_location "${_qt5SerialBus_install_prefix}/debug/bin/${LIB_LOCATION}")
    else()
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(imported_implib "${_qt5SerialBus_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    else()
...
if (NOT TARGET Qt5::SerialBus)
    ...
    set(Qt5SerialBus_PRIVATE_INCLUDE_DIRS
        "${_qt5SerialBus_install_prefix}/include/qt5/QtSerialBus/5.15.15"
        "${_qt5SerialBus_install_prefix}/include/qt5/QtSerialBus/5.15.15/QtSerialBus"
    )
    ...
    if (EXISTS
        "${_qt5SerialBus_install_prefix}/debug/bin/Qt5SerialBusd.dll"
      AND EXISTS
        "${_qt5SerialBus_install_prefix}/debug/lib/Qt5SerialBusd.lib" )
