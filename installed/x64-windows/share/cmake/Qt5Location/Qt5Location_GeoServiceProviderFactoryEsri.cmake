...
if(EXISTS "${_qt5Location_install_prefix}/plugins/geoservices/qtgeoservices_esri.dll")
    _populate_Location_plugin_properties(GeoServiceProviderFactoryEsri RELEASE "geoservices/qtgeoservices_esri.dll" FALSE)
endif()
if(EXISTS "${_qt5Location_install_prefix}/debug/plugins/geoservices/qtgeoservices_esrid.dll")
    _populate_Location_plugin_properties(GeoServiceProviderFactoryEsri DEBUG "geoservices/qtgeoservices_esrid.dll" FALSE)
endif()
