...
set(Qt5Pdf_VERSION_STRING 5.15.15)
...
macro(_populate_Pdf_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG") # 1
        set(imported_location "${_qt5Pdf_install_prefix}/debug/bin/${LIB_LOCATION}")
    else()
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(imported_implib "${_qt5Pdf_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    else()
...
if (NOT TARGET Qt5::Pdf)
    ...
    set(Qt5Pdf_PRIVATE_INCLUDE_DIRS
        "${_qt5Pdf_install_prefix}/include/qt5/QtPdf/5.15.15"
        "${_qt5Pdf_install_prefix}/include/qt5/QtPdf/5.15.15/QtPdf"
    )
    ...
    foreach(_module_dep ${_Qt5Pdf_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.15 ${_Qt5Pdf_FIND_VERSION_EXACT}
    ...
    if (EXISTS
        "${_qt5Pdf_install_prefix}/debug/bin/Qt5Pdfd.dll"
      AND EXISTS
        "${_qt5Pdf_install_prefix}/debug/lib/Qt5Pdfd.lib" )
