...
macro(_populate_RemoteObjects_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG") # 1
        set(imported_location "${_qt5RemoteObjects_install_prefix}/debug/bin/${LIB_LOCATION}")
    else()
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(imported_implib "${_qt5RemoteObjects_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    else()
...
if (NOT TARGET Qt5::RemoteObjects)
    ...
    set(Qt5RemoteObjects_PRIVATE_INCLUDE_DIRS
        "${_qt5RemoteObjects_install_prefix}/include/qt5/QtRemoteObjects/5.15.15"
        "${_qt5RemoteObjects_install_prefix}/include/qt5/QtRemoteObjects/5.15.15/QtRemoteObjects"
    )
    ...
    if (EXISTS
        "${_qt5RemoteObjects_install_prefix}/debug/bin/Qt5RemoteObjectsd.dll"
      AND EXISTS
        "${_qt5RemoteObjects_install_prefix}/debug/lib/Qt5RemoteObjectsd.lib" )
