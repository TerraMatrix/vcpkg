...
macro(_populate_WebView_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG") # 1
        set(imported_location "${_qt5WebView_install_prefix}/debug/bin/${LIB_LOCATION}")
    else()
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(imported_implib "${_qt5WebView_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    else()
...
if (NOT TARGET Qt5::WebView)
    ...
    if (EXISTS
        "${_qt5WebView_install_prefix}/debug/bin/Qt5WebViewd.dll"
      AND EXISTS
        "${_qt5WebView_install_prefix}/debug/lib/Qt5WebViewd.lib" )
