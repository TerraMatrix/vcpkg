...
set(Qt5Mqtt_VERSION_STRING 5.15.15)
...
if (NOT TARGET Qt5::Mqtt)
    ...
    set(Qt5Mqtt_PRIVATE_INCLUDE_DIRS
        "${_qt5Mqtt_install_prefix}/include/qt5/QtMqtt/5.15.15"
        "${_qt5Mqtt_install_prefix}/include/qt5/QtMqtt/5.15.15/QtMqtt"
    )
    ...
    foreach(_module_dep ${_Qt5Mqtt_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.15 ${_Qt5Mqtt_FIND_VERSION_EXACT}
    ...
    _populate_Mqtt_target_properties(RELEASE "Qt5Mqtt.dll" "Qt5Mqtt.lib" FALSE)

    if (EXISTS
        "${_qt5Mqtt_install_prefix}/debug/bin/Qt5Mqttd.dll"
      AND EXISTS
        "${_qt5Mqtt_install_prefix}/debug/lib/Qt5Mqttd.lib" )
        _populate_Mqtt_target_properties(DEBUG "Qt5Mqttd.dll" "Qt5Mqttd.lib" FALSE)
    endif()
