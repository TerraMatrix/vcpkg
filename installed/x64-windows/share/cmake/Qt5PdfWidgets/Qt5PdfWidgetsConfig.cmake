...
set(Qt5PdfWidgets_VERSION_STRING 5.15.15)
...
macro(_populate_PdfWidgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG") # 1
        set(imported_location "${_qt5PdfWidgets_install_prefix}/debug/bin/${LIB_LOCATION}")
    else()
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(imported_implib "${_qt5PdfWidgets_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    else()
...
if (NOT TARGET Qt5::PdfWidgets)
    ...
    set(Qt5PdfWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5PdfWidgets_install_prefix}/include/qt5/QtPdfWidgets/5.15.15"
        "${_qt5PdfWidgets_install_prefix}/include/qt5/QtPdfWidgets/5.15.15/QtPdfWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5PdfWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.15 ${_Qt5PdfWidgets_FIND_VERSION_EXACT}
    ...
    if (EXISTS
        "${_qt5PdfWidgets_install_prefix}/debug/bin/Qt5PdfWidgetsd.dll"
      AND EXISTS
        "${_qt5PdfWidgets_install_prefix}/debug/lib/Qt5PdfWidgetsd.lib" )
