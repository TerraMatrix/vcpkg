...
set_target_properties(Qt6::declarative_scxml PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/Qt6/qml/QtScxml/declarative_scxmlplugin.dll"
  )

list(APPEND _cmake_import_check_targets Qt6::declarative_scxml )
list(APPEND _cmake_import_check_files_for_Qt6::declarative_scxml "${_IMPORT_PREFIX}/Qt6/qml/QtScxml/declarative_scxmlplugin.dll" )
