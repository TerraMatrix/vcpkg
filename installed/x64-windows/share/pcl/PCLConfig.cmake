...
macro(find_openni2)
  ...
  if(NOT OPENNI2_ROOT AND ("TRUE" STREQUAL "TRUE"))
    set(OPENNI2_INCLUDE_DIRS_HINT "${VCPKG_IMPORT_PREFIX}/include/openni2")
    get_filename_component(OPENNI2_LIBRARY_HINT "${VCPKG_IMPORT_PREFIX}/lib/OpenNI2.lib" PATH)
  endif()
...
set(PCL_RELWITHDEBINFO_SUFFIX "rd")
set(PCL_MINSIZEREL_SUFFIX "s")
