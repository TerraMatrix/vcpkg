...
set_target_properties(gRPC::upb_base_lib PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libupb_base_lib.so.46.0.0"
  IMPORTED_SONAME_RELEASE "libupb_base_lib.so.46"
  )
...
set_target_properties(gRPC::upb_json_lib PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libupb_json_lib.so.46.0.0"
  IMPORTED_SONAME_RELEASE "libupb_json_lib.so.46"
  )
...
set_target_properties(gRPC::upb_mem_lib PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libupb_mem_lib.so.46.0.0"
  IMPORTED_SONAME_RELEASE "libupb_mem_lib.so.46"
  )
...
set_target_properties(gRPC::upb_message_lib PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libupb_message_lib.so.46.0.0"
  IMPORTED_SONAME_RELEASE "libupb_message_lib.so.46"
  )
...
set_target_properties(gRPC::upb_mini_descriptor_lib PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libupb_mini_descriptor_lib.so.46.0.0"
  IMPORTED_SONAME_RELEASE "libupb_mini_descriptor_lib.so.46"
  )
...
set_target_properties(gRPC::upb_textformat_lib PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libupb_textformat_lib.so.46.0.0"
  IMPORTED_SONAME_RELEASE "libupb_textformat_lib.so.46"
  )
...
set_target_properties(gRPC::upb_wire_lib PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libupb_wire_lib.so.46.0.0"
  IMPORTED_SONAME_RELEASE "libupb_wire_lib.so.46"
  )
