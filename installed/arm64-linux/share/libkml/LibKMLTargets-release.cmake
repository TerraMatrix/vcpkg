...
set_target_properties(kmlbase PROPERTIES
  IMPORTED_LOCATION_RELEASE "${VCPKG_IMPORT_PREFIX}/lib/libkmlbase.so.1.3.0"
  IMPORTED_SONAME_RELEASE "libkmlbase.so.1"
  )

list(APPEND _cmake_import_check_targets kmlbase )
list(APPEND _cmake_import_check_files_for_kmlbase "${VCPKG_IMPORT_PREFIX}/lib/libkmlbase.so.1.3.0" )
...
set_target_properties(kmldom PROPERTIES
  IMPORTED_LOCATION_RELEASE "${VCPKG_IMPORT_PREFIX}/lib/libkmldom.so.1.3.0"
  IMPORTED_SONAME_RELEASE "libkmldom.so.1"
  )

list(APPEND _cmake_import_check_targets kmldom )
list(APPEND _cmake_import_check_files_for_kmldom "${VCPKG_IMPORT_PREFIX}/lib/libkmldom.so.1.3.0" )
...
set_target_properties(kmlxsd PROPERTIES
  IMPORTED_LOCATION_RELEASE "${VCPKG_IMPORT_PREFIX}/lib/libkmlxsd.so.1.3.0"
  IMPORTED_SONAME_RELEASE "libkmlxsd.so.1"
  )

list(APPEND _cmake_import_check_targets kmlxsd )
list(APPEND _cmake_import_check_files_for_kmlxsd "${VCPKG_IMPORT_PREFIX}/lib/libkmlxsd.so.1.3.0" )
...
set_target_properties(kmlengine PROPERTIES
  IMPORTED_LOCATION_RELEASE "${VCPKG_IMPORT_PREFIX}/lib/libkmlengine.so.1.3.0"
  IMPORTED_SONAME_RELEASE "libkmlengine.so.1"
  )

list(APPEND _cmake_import_check_targets kmlengine )
list(APPEND _cmake_import_check_files_for_kmlengine "${VCPKG_IMPORT_PREFIX}/lib/libkmlengine.so.1.3.0" )
...
set_target_properties(kmlconvenience PROPERTIES
  IMPORTED_LOCATION_RELEASE "${VCPKG_IMPORT_PREFIX}/lib/libkmlconvenience.so.1.3.0"
  IMPORTED_SONAME_RELEASE "libkmlconvenience.so.1"
  )

list(APPEND _cmake_import_check_targets kmlconvenience )
list(APPEND _cmake_import_check_files_for_kmlconvenience "${VCPKG_IMPORT_PREFIX}/lib/libkmlconvenience.so.1.3.0" )
...
set_target_properties(kmlregionator PROPERTIES
  IMPORTED_LOCATION_RELEASE "${VCPKG_IMPORT_PREFIX}/lib/libkmlregionator.so.1.3.0"
  IMPORTED_SONAME_RELEASE "libkmlregionator.so.1"
  )

list(APPEND _cmake_import_check_targets kmlregionator )
list(APPEND _cmake_import_check_files_for_kmlregionator "${VCPKG_IMPORT_PREFIX}/lib/libkmlregionator.so.1.3.0" )
