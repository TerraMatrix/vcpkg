...
set_target_properties(unofficial::theora::theora PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libtheora.so"
  IMPORTED_SONAME_RELEASE "libtheora.so"
  )

list(APPEND _cmake_import_check_targets unofficial::theora::theora )
list(APPEND _cmake_import_check_files_for_unofficial::theora::theora "${_IMPORT_PREFIX}/lib/libtheora.so" )
...
set_target_properties(unofficial::theora::theoraenc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libtheoraenc.so"
  IMPORTED_SONAME_RELEASE "libtheoraenc.so"
  )

list(APPEND _cmake_import_check_targets unofficial::theora::theoraenc )
list(APPEND _cmake_import_check_files_for_unofficial::theora::theoraenc "${_IMPORT_PREFIX}/lib/libtheoraenc.so" )
...
set_target_properties(unofficial::theora::theoradec PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libtheoradec.so"
  IMPORTED_SONAME_RELEASE "libtheoradec.so"
  )

list(APPEND _cmake_import_check_targets unofficial::theora::theoradec )
list(APPEND _cmake_import_check_files_for_unofficial::theora::theoradec "${_IMPORT_PREFIX}/lib/libtheoradec.so" )
