...
set_target_properties(unofficial::poppler::poppler-cpp PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libpoppler-cpp.a"
  )

list(APPEND _cmake_import_check_targets unofficial::poppler::poppler-cpp )
list(APPEND _cmake_import_check_files_for_unofficial::poppler::poppler-cpp "${_IMPORT_PREFIX}/lib/libpoppler-cpp.a" )
