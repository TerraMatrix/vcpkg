...
set_target_properties(unofficial::poppler::poppler-private PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libpoppler.a"
  )

list(APPEND _cmake_import_check_targets unofficial::poppler::poppler-private )
list(APPEND _cmake_import_check_files_for_unofficial::poppler::poppler-private "${_IMPORT_PREFIX}/lib/libpoppler.a" )
