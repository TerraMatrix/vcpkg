...
if (NOT TARGET Qt5::Gamepad)
    ...
    _populate_Gamepad_target_properties(RELEASE "libQt5Gamepad.so.5.15.17" "" FALSE)

    if (EXISTS
        "${_qt5Gamepad_install_prefix}/debug/lib/libQt5Gamepad.so.5.15.17"
      AND EXISTS
        "${_qt5Gamepad_install_prefix}/debug/lib/" )
        _populate_Gamepad_target_properties(DEBUG "libQt5Gamepad.so.5.15.17" "" FALSE)
    endif()
