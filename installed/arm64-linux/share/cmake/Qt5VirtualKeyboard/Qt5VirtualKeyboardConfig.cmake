...
if (NOT TARGET Qt5::VirtualKeyboard)
    ...
    _populate_VirtualKeyboard_target_properties(RELEASE "libQt5VirtualKeyboard.so.5.15.17" "" FALSE)

    if (EXISTS
        "${_qt5VirtualKeyboard_install_prefix}/debug/lib/libQt5VirtualKeyboard.so.5.15.17"
      AND EXISTS
        "${_qt5VirtualKeyboard_install_prefix}/debug/lib/" )
        _populate_VirtualKeyboard_target_properties(DEBUG "libQt5VirtualKeyboard.so.5.15.17" "" FALSE)
    endif()
