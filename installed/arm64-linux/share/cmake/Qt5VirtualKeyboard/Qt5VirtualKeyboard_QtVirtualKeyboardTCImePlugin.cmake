...
if(EXISTS "${_qt5VirtualKeyboard_install_prefix}/plugins/virtualkeyboard/libqtvirtualkeyboard_tcime.prl")
...
if(EXISTS "${_qt5VirtualKeyboard_install_prefix}/debug/plugins/virtualkeyboard/libqtvirtualkeyboard_tcime.prl")
    _qt5_VirtualKeyboard_process_prl_file(
        "${_qt5VirtualKeyboard_install_prefix}/debug/plugins/virtualkeyboard/libqtvirtualkeyboard_tcime.prl" DEBUG
        _Qt5QtVirtualKeyboardTCImePlugin_STATIC_DEBUG_LIB_DEPENDENCIES
        _Qt5QtVirtualKeyboardTCImePlugin_STATIC_DEBUG_LINK_FLAGS
    )
endif()
...
if(EXISTS "${_qt5VirtualKeyboard_install_prefix}/plugins/virtualkeyboard/libqtvirtualkeyboard_tcime.a")
...
if(EXISTS "${_qt5VirtualKeyboard_install_prefix}/debug/plugins/virtualkeyboard/libqtvirtualkeyboard_tcime.a")
    _populate_VirtualKeyboard_plugin_properties(QtVirtualKeyboardTCImePlugin DEBUG "virtualkeyboard/libqtvirtualkeyboard_tcime.a" FALSE)
endif()
