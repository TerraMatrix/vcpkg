...
if (NOT TARGET Qt5::ScriptTools)
    ...
    set(Qt5ScriptTools_PRIVATE_INCLUDE_DIRS
        "${_qt5ScriptTools_install_prefix}/include/qt5/QtScriptTools/5.15.17"
        "${_qt5ScriptTools_install_prefix}/include/qt5/QtScriptTools/5.15.17/QtScriptTools"
    )
    ...
    if(EXISTS "${_qt5ScriptTools_install_prefix}/debug/lib/libQt5ScriptTools.prl")
        _qt5_ScriptTools_process_prl_file(
            "${_qt5ScriptTools_install_prefix}/debug/lib/libQt5ScriptTools.prl" DEBUG
    ...
    if (EXISTS
        "${_qt5ScriptTools_install_prefix}/debug/lib/libQt5ScriptTools.a"
      AND EXISTS
        "${_qt5ScriptTools_install_prefix}/debug/lib/" )
        _populate_ScriptTools_target_properties(DEBUG "libQt5ScriptTools.a" "" FALSE)
    endif()
