...
if (NOT TARGET Qt5::PrintSupport)
    ...
    if (EXISTS
        "${_qt5PrintSupport_install_prefix}/debug/lib/libQt5PrintSupport.so.5.15.17"
      AND EXISTS
        "${_qt5PrintSupport_install_prefix}/debug/lib/" )
        _populate_PrintSupport_target_properties(DEBUG "libQt5PrintSupport.so.5.15.17" "" FALSE)
    endif()
