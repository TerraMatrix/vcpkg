...
if (NOT TARGET Qt5::3DInput)
    ...
    _populate_3DInput_target_properties(RELEASE "libQt53DInput.so.5.15.17" "" FALSE)

    if (EXISTS
        "${_qt53DInput_install_prefix}/debug/lib/libQt53DInput.so.5.15.17"
      AND EXISTS
        "${_qt53DInput_install_prefix}/debug/lib/" )
        _populate_3DInput_target_properties(DEBUG "libQt53DInput.so.5.15.17" "" FALSE)
    endif()
