...
if (NOT TARGET Qt5::NetworkAuth)
    ...
    set(Qt5NetworkAuth_PRIVATE_INCLUDE_DIRS
        "${_qt5NetworkAuth_install_prefix}/include/qt5/QtNetworkAuth/5.15.17"
        "${_qt5NetworkAuth_install_prefix}/include/qt5/QtNetworkAuth/5.15.17/QtNetworkAuth"
    )
    ...
    if(EXISTS "${_qt5NetworkAuth_install_prefix}/debug/lib/libQt5NetworkAuth.prl")
        _qt5_NetworkAuth_process_prl_file(
            "${_qt5NetworkAuth_install_prefix}/debug/lib/libQt5NetworkAuth.prl" DEBUG
    ...
    if (EXISTS
        "${_qt5NetworkAuth_install_prefix}/debug/lib/libQt5NetworkAuth.a"
      AND EXISTS
        "${_qt5NetworkAuth_install_prefix}/debug/lib/" )
        _populate_NetworkAuth_target_properties(DEBUG "libQt5NetworkAuth.a" "" FALSE)
    endif()
