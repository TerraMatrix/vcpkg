...
if(EXISTS "${_qt5Qml_install_prefix}/plugins/qmltooling/libqmldbg_messages.so")
    _populate_Qml_plugin_properties(QDebugMessageServiceFactory RELEASE "qmltooling/libqmldbg_messages.so" FALSE)
endif()
if(EXISTS "${_qt5Qml_install_prefix}/debug/plugins/qmltooling/libqmldbg_messages.so")
    _populate_Qml_plugin_properties(QDebugMessageServiceFactory DEBUG "qmltooling/libqmldbg_messages.so" FALSE)
endif()
