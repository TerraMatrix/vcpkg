...
if (NOT TARGET Qt5::Qml)
    ...
    set(Qt5Qml_PRIVATE_INCLUDE_DIRS
        "${_qt5Qml_install_prefix}/include/qt5/QtQml/5.15.17"
        "${_qt5Qml_install_prefix}/include/qt5/QtQml/5.15.17/QtQml"
    )
    ...
    if(EXISTS "${_qt5Qml_install_prefix}/debug/lib/libQt5Qml.prl")
        _qt5_Qml_process_prl_file(
            "${_qt5Qml_install_prefix}/debug/lib/libQt5Qml.prl" DEBUG
    ...
    if (EXISTS
        "${_qt5Qml_install_prefix}/debug/lib/libQt5Qml.a"
      AND EXISTS
        "${_qt5Qml_install_prefix}/debug/lib/" )
        _populate_Qml_target_properties(DEBUG "libQt5Qml.a" "" FALSE)
    endif()
