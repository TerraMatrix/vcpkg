...
if(EXISTS "${_qt5Qml_install_prefix}/plugins/qmltooling/libqmldbg_inspector.so")
    _populate_Qml_plugin_properties(QQmlInspectorServiceFactory RELEASE "qmltooling/libqmldbg_inspector.so" FALSE)
endif()
if(EXISTS "${_qt5Qml_install_prefix}/debug/plugins/qmltooling/libqmldbg_inspector.so")
    _populate_Qml_plugin_properties(QQmlInspectorServiceFactory DEBUG "qmltooling/libqmldbg_inspector.so" FALSE)
endif()
