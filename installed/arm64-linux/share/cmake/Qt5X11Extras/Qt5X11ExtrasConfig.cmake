...
function(_qt5_X11Extras_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(_qt5_install_libs "${_qt5X11Extras_install_prefix}/debug/lib/")
    else()
...
macro(_populate_X11Extras_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG") # 1
        set(imported_location "${_qt5X11Extras_install_prefix}/debug/lib/${LIB_LOCATION}")
    else()
    ...
    if(_static_deps)
        ...
        #message(STATUS "Target Qt5::X11Extras static links: ${_static_dep} through ${_static_dep_genex}") # Added for debugging
    endif()
    ...
    if(_static_link_flags)
        ...
        if(NOT CMAKE_VERSION VERSION_LESS "3.13")
            ...
            #message(STATUS "Target Qt5::X11Extras static link flags: ${_static_link_flags} through ${_static_link_flags_genex}")
        endif()
    endif()
...
if (NOT TARGET Qt5::X11Extras)
    ...
    if(EXISTS "${_qt5X11Extras_install_prefix}/debug/lib/libQt5X11Extras.prl")
        _qt5_X11Extras_process_prl_file(
            "${_qt5X11Extras_install_prefix}/debug/lib/libQt5X11Extras.prl" DEBUG
            _Qt5X11Extras_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5X11Extras_STATIC_DEBUG_LINK_FLAGS
        )
    endif()

    if(EXISTS "${_qt5X11Extras_install_prefix}/lib/libQt5X11Extras.prl")
        _qt5_X11Extras_process_prl_file(
    ...
    if (EXISTS
        "${_qt5X11Extras_install_prefix}/debug/lib/libQt5X11Extras.a"
      AND EXISTS
        "${_qt5X11Extras_install_prefix}/debug/lib/" )
        _populate_X11Extras_target_properties(DEBUG "libQt5X11Extras.a" "" FALSE)
    endif()
    ...
    macro(_populate_X11Extras_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        if("${Configuration}" STREQUAL "DEBUG")
            set(imported_location "${_qt5X11Extras_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
        else()
