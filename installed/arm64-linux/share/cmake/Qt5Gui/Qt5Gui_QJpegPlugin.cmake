...
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/imageformats/libqjpeg.prl")
    _qt5_Gui_process_prl_file(
        "${_qt5Gui_install_prefix}/debug/plugins/imageformats/libqjpeg.prl" DEBUG
...
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/imageformats/libqjpeg.a")
    _populate_Gui_plugin_properties(QJpegPlugin DEBUG "imageformats/libqjpeg.a" FALSE)
endif()
