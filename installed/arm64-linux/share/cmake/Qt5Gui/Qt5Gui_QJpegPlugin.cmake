...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/imageformats/libqjpeg.so")
    _populate_Gui_plugin_properties(QJpegPlugin RELEASE "imageformats/libqjpeg.so" FALSE)
endif()
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/imageformats/libqjpeg.so")
    _populate_Gui_plugin_properties(QJpegPlugin DEBUG "imageformats/libqjpeg.so" FALSE)
endif()
