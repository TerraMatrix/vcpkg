...
if (NOT TARGET Qt5::Gui)
    ...
    set(Qt5Gui_PRIVATE_INCLUDE_DIRS
        "${_qt5Gui_install_prefix}/include/qt5/QtGui/5.15.17"
        "${_qt5Gui_install_prefix}/include/qt5/QtGui/5.15.17/QtGui"
    )
    ...
    if(EXISTS "${_qt5Gui_install_prefix}/debug/lib/libQt5Gui.prl")
        _qt5_Gui_process_prl_file(
            "${_qt5Gui_install_prefix}/debug/lib/libQt5Gui.prl" DEBUG
    ...
    set_property(TARGET Qt5::Gui
                 ...
                 xkbcommon;xkbcommon-x11;xcb;accessibility-atspi-bridge;drm_atomic;egl;egl_x11;eglfs;kms;eglfs_egldevice;xlib;xcb-xlib;eglfs_x11;evdev;freetype;system-freetype;fontconfig;gif;harfbuzz;ico;imageio-text-loading;jpeg;linuxfb;multiprocess;png;raster-64bit;system-harfbuzz;system-jpeg;system-png;tuiotouch;vnc;xcb-egl-plugin;xcb-glx-plugin;xcb-glx;xcb-sm)
    set_property(TARGET Qt5::Gui
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 angle_d3d11_qdtd;direct2d;direct2d1_1;dxgi;direct3d11;direct3d11_1;direct3d9;directfb;dxgi1_2;dxguid;eglfs_brcm;eglfs_gbm;eglfs_mali;eglfs_openwfd;eglfs_rcar;eglfs_viv;eglfs_viv_wl;eglfs_vsp2;integrityfb;integrityhid;libinput;libinput-axis-api;mtdev;system-xcb-xinput;tslib;vkgen;vsp2;xcb-native-painting)
    ...
    if (EXISTS
        "${_qt5Gui_install_prefix}/debug/lib/libQt5Gui.a"
      AND EXISTS
