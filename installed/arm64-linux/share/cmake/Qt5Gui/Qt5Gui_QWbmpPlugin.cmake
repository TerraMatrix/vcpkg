...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/imageformats/libqwbmp.so")
    _populate_Gui_plugin_properties(QWbmpPlugin RELEASE "imageformats/libqwbmp.so" FALSE)
endif()
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/imageformats/libqwbmp.so")
    _populate_Gui_plugin_properties(QWbmpPlugin DEBUG "imageformats/libqwbmp.so" FALSE)
endif()
