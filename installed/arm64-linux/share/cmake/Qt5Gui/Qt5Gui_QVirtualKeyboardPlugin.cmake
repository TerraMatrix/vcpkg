...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/platforminputcontexts/libqtvirtualkeyboardplugin.prl")
...
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/platforminputcontexts/libqtvirtualkeyboardplugin.prl")
    _qt5_Gui_process_prl_file(
        "${_qt5Gui_install_prefix}/debug/plugins/platforminputcontexts/libqtvirtualkeyboardplugin.prl" DEBUG
        _Qt5QVirtualKeyboardPlugin_STATIC_DEBUG_LIB_DEPENDENCIES
        _Qt5QVirtualKeyboardPlugin_STATIC_DEBUG_LINK_FLAGS
    )
endif()
...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/platforminputcontexts/libqtvirtualkeyboardplugin.a")
    _populate_Gui_plugin_properties(QVirtualKeyboardPlugin RELEASE "platforminputcontexts/libqtvirtualkeyboardplugin.a" FALSE)
endif()
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/platforminputcontexts/libqtvirtualkeyboardplugin.a")
    _populate_Gui_plugin_properties(QVirtualKeyboardPlugin DEBUG "platforminputcontexts/libqtvirtualkeyboardplugin.a" FALSE)
endif()
