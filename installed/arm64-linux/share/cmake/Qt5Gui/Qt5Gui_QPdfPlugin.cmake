...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/imageformats/libqpdf.so")
    _populate_Gui_plugin_properties(QPdfPlugin RELEASE "imageformats/libqpdf.so" FALSE)
endif()
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/imageformats/libqpdf.so")
    _populate_Gui_plugin_properties(QPdfPlugin DEBUG "imageformats/libqpdf.so" FALSE)
endif()
