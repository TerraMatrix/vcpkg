...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/imageformats/libqtga.so")
    _populate_Gui_plugin_properties(QTgaPlugin RELEASE "imageformats/libqtga.so" FALSE)
endif()
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/imageformats/libqtga.so")
    _populate_Gui_plugin_properties(QTgaPlugin DEBUG "imageformats/libqtga.so" FALSE)
endif()
