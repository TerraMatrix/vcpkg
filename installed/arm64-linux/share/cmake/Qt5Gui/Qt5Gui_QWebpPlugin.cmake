...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/imageformats/libqwebp.so")
    _populate_Gui_plugin_properties(QWebpPlugin RELEASE "imageformats/libqwebp.so" FALSE)
endif()
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/imageformats/libqwebp.so")
    _populate_Gui_plugin_properties(QWebpPlugin DEBUG "imageformats/libqwebp.so" FALSE)
endif()
