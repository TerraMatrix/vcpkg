...
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/platforms/libqoffscreen.prl")
    _qt5_Gui_process_prl_file(
        "${_qt5Gui_install_prefix}/debug/plugins/platforms/libqoffscreen.prl" DEBUG
...
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/platforms/libqoffscreen.a")
    _populate_Gui_plugin_properties(QOffscreenIntegrationPlugin DEBUG "platforms/libqoffscreen.a" FALSE)
endif()
