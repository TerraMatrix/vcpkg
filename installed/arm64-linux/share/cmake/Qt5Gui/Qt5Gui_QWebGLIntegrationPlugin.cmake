...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/platforms/libqwebgl.prl")
...
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/platforms/libqwebgl.prl")
    _qt5_Gui_process_prl_file(
        "${_qt5Gui_install_prefix}/debug/plugins/platforms/libqwebgl.prl" DEBUG
        _Qt5QWebGLIntegrationPlugin_STATIC_DEBUG_LIB_DEPENDENCIES
        _Qt5QWebGLIntegrationPlugin_STATIC_DEBUG_LINK_FLAGS
    )
endif()
...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/platforms/libqwebgl.a")
    _populate_Gui_plugin_properties(QWebGLIntegrationPlugin RELEASE "platforms/libqwebgl.a" FALSE)
endif()
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/platforms/libqwebgl.a")
    _populate_Gui_plugin_properties(QWebGLIntegrationPlugin DEBUG "platforms/libqwebgl.a" FALSE)
endif()
