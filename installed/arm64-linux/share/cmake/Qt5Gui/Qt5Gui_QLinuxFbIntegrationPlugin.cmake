...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/platforms/libqlinuxfb.so")
    _populate_Gui_plugin_properties(QLinuxFbIntegrationPlugin RELEASE "platforms/libqlinuxfb.so" FALSE)
endif()
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/platforms/libqlinuxfb.so")
    _populate_Gui_plugin_properties(QLinuxFbIntegrationPlugin DEBUG "platforms/libqlinuxfb.so" FALSE)
endif()
