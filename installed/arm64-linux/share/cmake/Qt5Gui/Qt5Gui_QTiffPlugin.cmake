...
if(EXISTS "${_qt5Gui_install_prefix}/plugins/imageformats/libqtiff.so")
    _populate_Gui_plugin_properties(QTiffPlugin RELEASE "imageformats/libqtiff.so" FALSE)
endif()
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/imageformats/libqtiff.so")
    _populate_Gui_plugin_properties(QTiffPlugin DEBUG "imageformats/libqtiff.so" FALSE)
endif()
