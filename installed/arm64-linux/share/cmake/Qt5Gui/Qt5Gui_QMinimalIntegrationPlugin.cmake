...
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/platforms/libqminimal.prl")
    _qt5_Gui_process_prl_file(
        "${_qt5Gui_install_prefix}/debug/plugins/platforms/libqminimal.prl" DEBUG
...
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/platforms/libqminimal.a")
    _populate_Gui_plugin_properties(QMinimalIntegrationPlugin DEBUG "platforms/libqminimal.a" FALSE)
endif()
