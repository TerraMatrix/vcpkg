...
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/iconengines/libqsvgicon.prl")
    _qt5_Gui_process_prl_file(
        "${_qt5Gui_install_prefix}/debug/plugins/iconengines/libqsvgicon.prl" DEBUG
...
if(EXISTS "${_qt5Gui_install_prefix}/debug/plugins/iconengines/libqsvgicon.a")
    _populate_Gui_plugin_properties(QSvgIconPlugin DEBUG "iconengines/libqsvgicon.a" FALSE)
endif()
