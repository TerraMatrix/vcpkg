...
if (NOT TARGET Qt5::QuickTemplates2)
    ...
    set(Qt5QuickTemplates2_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTemplates2_install_prefix}/include/qt5/QtQuickTemplates2/5.15.17"
        "${_qt5QuickTemplates2_install_prefix}/include/qt5/QtQuickTemplates2/5.15.17/QtQuickTemplates2"
    )
    ...
    if(EXISTS "${_qt5QuickTemplates2_install_prefix}/debug/lib/libQt5QuickTemplates2.prl")
        _qt5_QuickTemplates2_process_prl_file(
            "${_qt5QuickTemplates2_install_prefix}/debug/lib/libQt5QuickTemplates2.prl" DEBUG
    ...
    if (EXISTS
        "${_qt5QuickTemplates2_install_prefix}/debug/lib/libQt5QuickTemplates2.a"
      AND EXISTS
        "${_qt5QuickTemplates2_install_prefix}/debug/lib/" )
        _populate_QuickTemplates2_target_properties(DEBUG "libQt5QuickTemplates2.a" "" FALSE)
    endif()
