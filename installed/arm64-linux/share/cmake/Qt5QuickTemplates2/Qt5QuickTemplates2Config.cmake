...
if (NOT TARGET Qt5::QuickTemplates2)
    ...
    if (EXISTS
        "${_qt5QuickTemplates2_install_prefix}/debug/lib/libQt5QuickTemplates2.so.5.15.17"
      AND EXISTS
        "${_qt5QuickTemplates2_install_prefix}/debug/lib/" )
        _populate_QuickTemplates2_target_properties(DEBUG "libQt5QuickTemplates2.so.5.15.17" "" FALSE)
    endif()
