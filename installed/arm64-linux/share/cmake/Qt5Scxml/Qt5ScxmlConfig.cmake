...
function(_qt5_Scxml_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(_qt5_install_libs "${_qt5Scxml_install_prefix}/debug/lib/")
    else()
...
macro(_populate_Scxml_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG") # 1
        set(imported_location "${_qt5Scxml_install_prefix}/debug/lib/${LIB_LOCATION}")
    else()
    ...
    if(_static_deps)
        ...
        #message(STATUS "Target Qt5::Scxml static links: ${_static_dep} through ${_static_dep_genex}") # Added for debugging
    endif()
    ...
    if(_static_link_flags)
        ...
        if(NOT CMAKE_VERSION VERSION_LESS "3.13")
            ...
            #message(STATUS "Target Qt5::Scxml static link flags: ${_static_link_flags} through ${_static_link_flags_genex}")
        endif()
    endif()
...
if (NOT TARGET Qt5::Scxml)
    ...
    set(Qt5Scxml_PRIVATE_INCLUDE_DIRS
        "${_qt5Scxml_install_prefix}/include/qt5/QtScxml/5.15.17"
        "${_qt5Scxml_install_prefix}/include/qt5/QtScxml/5.15.17/QtScxml"
    )
    ...
    if(EXISTS "${_qt5Scxml_install_prefix}/debug/lib/libQt5Scxml.prl")
        _qt5_Scxml_process_prl_file(
            "${_qt5Scxml_install_prefix}/debug/lib/libQt5Scxml.prl" DEBUG
            _Qt5Scxml_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5Scxml_STATIC_DEBUG_LINK_FLAGS
        )
    endif()

    if(EXISTS "${_qt5Scxml_install_prefix}/lib/libQt5Scxml.prl")
        _qt5_Scxml_process_prl_file(
    ...
    if (EXISTS
        "${_qt5Scxml_install_prefix}/debug/lib/libQt5Scxml.a"
      AND EXISTS
        "${_qt5Scxml_install_prefix}/debug/lib/" )
        _populate_Scxml_target_properties(DEBUG "libQt5Scxml.a" "" FALSE)
    endif()
