...
if (NOT TARGET Qt5::QmlWorkerScript)
    ...
    if (EXISTS
        "${_qt5QmlWorkerScript_install_prefix}/debug/lib/libQt5QmlWorkerScript.so.5.15.17"
      AND EXISTS
        "${_qt5QmlWorkerScript_install_prefix}/debug/lib/" )
        _populate_QmlWorkerScript_target_properties(DEBUG "libQt5QmlWorkerScript.so.5.15.17" "" FALSE)
    endif()
