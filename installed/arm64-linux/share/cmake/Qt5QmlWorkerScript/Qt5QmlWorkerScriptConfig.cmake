...
if (NOT TARGET Qt5::QmlWorkerScript)
    ...
    set(Qt5QmlWorkerScript_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlWorkerScript_install_prefix}/include/qt5/QtQmlWorkerScript/5.15.17"
        "${_qt5QmlWorkerScript_install_prefix}/include/qt5/QtQmlWorkerScript/5.15.17/QtQmlWorkerScript"
    )
    ...
    if(EXISTS "${_qt5QmlWorkerScript_install_prefix}/debug/lib/libQt5QmlWorkerScript.prl")
        _qt5_QmlWorkerScript_process_prl_file(
            "${_qt5QmlWorkerScript_install_prefix}/debug/lib/libQt5QmlWorkerScript.prl" DEBUG
    ...
    if (EXISTS
        "${_qt5QmlWorkerScript_install_prefix}/debug/lib/libQt5QmlWorkerScript.a"
      AND EXISTS
        "${_qt5QmlWorkerScript_install_prefix}/debug/lib/" )
        _populate_QmlWorkerScript_target_properties(DEBUG "libQt5QmlWorkerScript.a" "" FALSE)
    endif()
