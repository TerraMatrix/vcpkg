...
if (NOT TARGET Qt5::3DQuickInput)
    ...
    _populate_3DQuickInput_target_properties(RELEASE "libQt53DQuickInput.so.5.15.17" "" FALSE)

    if (EXISTS
        "${_qt53DQuickInput_install_prefix}/debug/lib/libQt53DQuickInput.so.5.15.17"
      AND EXISTS
        "${_qt53DQuickInput_install_prefix}/debug/lib/" )
        _populate_3DQuickInput_target_properties(DEBUG "libQt53DQuickInput.so.5.15.17" "" FALSE)
    endif()
