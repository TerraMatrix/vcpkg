...
if (NOT TARGET Qt5::Nfc)
    ...
    _populate_Nfc_target_properties(RELEASE "libQt5Nfc.so.5.15.17" "" FALSE)

    if (EXISTS
        "${_qt5Nfc_install_prefix}/debug/lib/libQt5Nfc.so.5.15.17"
      AND EXISTS
        "${_qt5Nfc_install_prefix}/debug/lib/" )
        _populate_Nfc_target_properties(DEBUG "libQt5Nfc.so.5.15.17" "" FALSE)
    endif()
