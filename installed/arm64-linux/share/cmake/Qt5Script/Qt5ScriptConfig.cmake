...
if (NOT TARGET Qt5::Script)
    ...
    set(Qt5Script_PRIVATE_INCLUDE_DIRS
        "${_qt5Script_install_prefix}/include/qt5/QtScript/5.15.17"
        "${_qt5Script_install_prefix}/include/qt5/QtScript/5.15.17/QtScript"
    )
    ...
    if(EXISTS "${_qt5Script_install_prefix}/debug/lib/libQt5Script.prl")
        _qt5_Script_process_prl_file(
            "${_qt5Script_install_prefix}/debug/lib/libQt5Script.prl" DEBUG
    ...
    if (EXISTS
        "${_qt5Script_install_prefix}/debug/lib/libQt5Script.a"
      AND EXISTS
        "${_qt5Script_install_prefix}/debug/lib/" )
        _populate_Script_target_properties(DEBUG "libQt5Script.a" "" FALSE)
    endif()
