...
if (NOT TARGET Qt5::MultimediaWidgets)
    ...
    if (EXISTS
        "${_qt5MultimediaWidgets_install_prefix}/debug/lib/libQt5MultimediaWidgets.so.5.15.17"
      AND EXISTS
        "${_qt5MultimediaWidgets_install_prefix}/debug/lib/" )
        _populate_MultimediaWidgets_target_properties(DEBUG "libQt5MultimediaWidgets.so.5.15.17" "" FALSE)
    endif()
