...
if (NOT TARGET Qt5::Mqtt)
    ...
    _populate_Mqtt_target_properties(RELEASE "libQt5Mqtt.so.5.15.3" "" FALSE)

    if (EXISTS
        "${_qt5Mqtt_install_prefix}/debug/lib/libQt5Mqtt.so.5.15.3"
      AND EXISTS
        "${_qt5Mqtt_install_prefix}/debug/lib/" )
        _populate_Mqtt_target_properties(DEBUG "libQt5Mqtt.so.5.15.3" "" FALSE)
    endif()
