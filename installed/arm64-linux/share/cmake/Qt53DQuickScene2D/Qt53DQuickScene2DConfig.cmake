...
if (NOT TARGET Qt5::3DQuickScene2D)
    ...
    _populate_3DQuickScene2D_target_properties(RELEASE "libQt53DQuickScene2D.so.5.15.17" "" FALSE)

    if (EXISTS
        "${_qt53DQuickScene2D_install_prefix}/debug/lib/libQt53DQuickScene2D.so.5.15.17"
      AND EXISTS
        "${_qt53DQuickScene2D_install_prefix}/debug/lib/" )
        _populate_3DQuickScene2D_target_properties(DEBUG "libQt53DQuickScene2D.so.5.15.17" "" FALSE)
    endif()
