...
if (NOT TARGET Qt5::3DAnimation)
    ...
    _populate_3DAnimation_target_properties(RELEASE "libQt53DAnimation.so.5.15.17" "" FALSE)

    if (EXISTS
        "${_qt53DAnimation_install_prefix}/debug/lib/libQt53DAnimation.so.5.15.17"
      AND EXISTS
        "${_qt53DAnimation_install_prefix}/debug/lib/" )
        _populate_3DAnimation_target_properties(DEBUG "libQt53DAnimation.so.5.15.17" "" FALSE)
    endif()
