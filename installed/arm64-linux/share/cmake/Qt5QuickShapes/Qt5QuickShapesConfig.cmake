...
if (NOT TARGET Qt5::QuickShapes)
    ...
    set(Qt5QuickShapes_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickShapes_install_prefix}/include/qt5/QtQuickShapes/5.15.17"
        "${_qt5QuickShapes_install_prefix}/include/qt5/QtQuickShapes/5.15.17/QtQuickShapes"
    )
    ...
    if(EXISTS "${_qt5QuickShapes_install_prefix}/debug/lib/libQt5QuickShapes.prl")
        _qt5_QuickShapes_process_prl_file(
            "${_qt5QuickShapes_install_prefix}/debug/lib/libQt5QuickShapes.prl" DEBUG
    ...
    if (EXISTS
        "${_qt5QuickShapes_install_prefix}/debug/lib/libQt5QuickShapes.a"
      AND EXISTS
        "${_qt5QuickShapes_install_prefix}/debug/lib/" )
        _populate_QuickShapes_target_properties(DEBUG "libQt5QuickShapes.a" "" FALSE)
    endif()
