...
if (NOT TARGET Qt5::EglFsKmsSupport)
    ...
    _populate_EglFsKmsSupport_target_properties(RELEASE "libQt5EglFsKmsSupport.so.5.15.17" "" FALSE)

    if (EXISTS
        "${_qt5EglFsKmsSupport_install_prefix}/debug/lib/libQt5EglFsKmsSupport.so.5.15.17"
      AND EXISTS
        "${_qt5EglFsKmsSupport_install_prefix}/debug/lib/" )
        _populate_EglFsKmsSupport_target_properties(DEBUG "libQt5EglFsKmsSupport.so.5.15.17" "" FALSE)
    endif()
