...
if (NOT TARGET Qt5::Bluetooth)
    ...
    _populate_Bluetooth_target_properties(RELEASE "libQt5Bluetooth.so.5.15.17" "" FALSE)

    if (EXISTS
        "${_qt5Bluetooth_install_prefix}/debug/lib/libQt5Bluetooth.so.5.15.17"
      AND EXISTS
        "${_qt5Bluetooth_install_prefix}/debug/lib/" )
        _populate_Bluetooth_target_properties(DEBUG "libQt5Bluetooth.so.5.15.17" "" FALSE)
    endif()
