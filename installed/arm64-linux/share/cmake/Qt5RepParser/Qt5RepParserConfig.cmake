...
function(_qt5_RepParser_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(_qt5_install_libs "${_qt5RepParser_install_prefix}/debug/lib/")
    else()
...
if (NOT TARGET Qt5::RepParser)
    ...
    set(_Qt5RepParser_OWN_INCLUDE_DIRS "${_qt5RepParser_install_prefix}/include/qt5/" "${_qt5RepParser_install_prefix}/include/qt5/QtRepParser")
    ...
    if(EXISTS "${_qt5RepParser_install_prefix}/debug/lib/libQt5RepParser.prl")
        _qt5_RepParser_process_prl_file(
            "${_qt5RepParser_install_prefix}/debug/lib/libQt5RepParser.prl" DEBUG
            _Qt5RepParser_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5RepParser_STATIC_DEBUG_LINK_FLAGS
        )
    endif()

    if(EXISTS "${_qt5RepParser_install_prefix}/lib/libQt5RepParser.prl")
        _qt5_RepParser_process_prl_file(
    ...
    macro(_populate_RepParser_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        if("${Configuration}" STREQUAL "DEBUG")
            set(imported_location "${_qt5RepParser_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
        else()
