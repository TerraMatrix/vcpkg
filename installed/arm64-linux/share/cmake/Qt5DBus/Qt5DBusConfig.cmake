...
if (NOT TARGET Qt5::DBus)
    ...
    set(Qt5DBus_PRIVATE_INCLUDE_DIRS
        "${_qt5DBus_install_prefix}/include/qt5/QtDBus/5.15.17"
        "${_qt5DBus_install_prefix}/include/qt5/QtDBus/5.15.17/QtDBus"
    )
    ...
    if(EXISTS "${_qt5DBus_install_prefix}/debug/lib/libQt5DBus.prl")
        _qt5_DBus_process_prl_file(
            "${_qt5DBus_install_prefix}/debug/lib/libQt5DBus.prl" DEBUG
    ...
    if (EXISTS
        "${_qt5DBus_install_prefix}/debug/lib/libQt5DBus.a"
      AND EXISTS
