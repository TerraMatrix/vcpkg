...
if(EXISTS "${_qt5SerialBus_install_prefix}/plugins/canbus/libqtpeakcanbus.prl")
...
if(EXISTS "${_qt5SerialBus_install_prefix}/debug/plugins/canbus/libqtpeakcanbus.prl")
    _qt5_SerialBus_process_prl_file(
        "${_qt5SerialBus_install_prefix}/debug/plugins/canbus/libqtpeakcanbus.prl" DEBUG
        _Qt5PeakCanBusPlugin_STATIC_DEBUG_LIB_DEPENDENCIES
        _Qt5PeakCanBusPlugin_STATIC_DEBUG_LINK_FLAGS
    )
endif()
...
if(EXISTS "${_qt5SerialBus_install_prefix}/plugins/canbus/libqtpeakcanbus.a")
    _populate_SerialBus_plugin_properties(PeakCanBusPlugin RELEASE "canbus/libqtpeakcanbus.a" FALSE)
endif()
if(EXISTS "${_qt5SerialBus_install_prefix}/debug/plugins/canbus/libqtpeakcanbus.a")
    _populate_SerialBus_plugin_properties(PeakCanBusPlugin DEBUG "canbus/libqtpeakcanbus.a" FALSE)
endif()
