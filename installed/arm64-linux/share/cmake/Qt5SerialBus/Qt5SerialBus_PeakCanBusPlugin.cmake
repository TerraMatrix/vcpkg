...
if(EXISTS "${_qt5SerialBus_install_prefix}/plugins/canbus/libqtpeakcanbus.so")
    _populate_SerialBus_plugin_properties(PeakCanBusPlugin RELEASE "canbus/libqtpeakcanbus.so" FALSE)
endif()
if(EXISTS "${_qt5SerialBus_install_prefix}/debug/plugins/canbus/libqtpeakcanbus.so")
    _populate_SerialBus_plugin_properties(PeakCanBusPlugin DEBUG "canbus/libqtpeakcanbus.so" FALSE)
endif()
