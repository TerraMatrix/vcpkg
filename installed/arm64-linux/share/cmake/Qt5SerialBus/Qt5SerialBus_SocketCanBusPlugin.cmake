...
if(EXISTS "${_qt5SerialBus_install_prefix}/plugins/canbus/libqtsocketcanbus.so")
    _populate_SerialBus_plugin_properties(SocketCanBusPlugin RELEASE "canbus/libqtsocketcanbus.so" FALSE)
endif()
if(EXISTS "${_qt5SerialBus_install_prefix}/debug/plugins/canbus/libqtsocketcanbus.so")
    _populate_SerialBus_plugin_properties(SocketCanBusPlugin DEBUG "canbus/libqtsocketcanbus.so" FALSE)
endif()
