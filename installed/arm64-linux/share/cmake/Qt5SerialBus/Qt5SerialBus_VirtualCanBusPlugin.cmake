...
if(EXISTS "${_qt5SerialBus_install_prefix}/plugins/canbus/libqtvirtualcanbus.prl")
...
if(EXISTS "${_qt5SerialBus_install_prefix}/debug/plugins/canbus/libqtvirtualcanbus.prl")
    _qt5_SerialBus_process_prl_file(
        "${_qt5SerialBus_install_prefix}/debug/plugins/canbus/libqtvirtualcanbus.prl" DEBUG
        _Qt5VirtualCanBusPlugin_STATIC_DEBUG_LIB_DEPENDENCIES
        _Qt5VirtualCanBusPlugin_STATIC_DEBUG_LINK_FLAGS
    )
endif()
...
if(EXISTS "${_qt5SerialBus_install_prefix}/plugins/canbus/libqtvirtualcanbus.a")
    _populate_SerialBus_plugin_properties(VirtualCanBusPlugin RELEASE "canbus/libqtvirtualcanbus.a" FALSE)
endif()
if(EXISTS "${_qt5SerialBus_install_prefix}/debug/plugins/canbus/libqtvirtualcanbus.a")
    _populate_SerialBus_plugin_properties(VirtualCanBusPlugin DEBUG "canbus/libqtvirtualcanbus.a" FALSE)
endif()
...
set_property(TARGET Qt5::VirtualCanBusPlugin APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    "Qt5::SerialBus;Qt5::Network;Qt5::Core"
)
