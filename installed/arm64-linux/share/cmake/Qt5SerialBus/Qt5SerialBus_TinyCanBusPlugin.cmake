...
if(EXISTS "${_qt5SerialBus_install_prefix}/plugins/canbus/libqttinycanbus.prl")
...
if(EXISTS "${_qt5SerialBus_install_prefix}/debug/plugins/canbus/libqttinycanbus.prl")
    _qt5_SerialBus_process_prl_file(
        "${_qt5SerialBus_install_prefix}/debug/plugins/canbus/libqttinycanbus.prl" DEBUG
        _Qt5TinyCanBusPlugin_STATIC_DEBUG_LIB_DEPENDENCIES
        _Qt5TinyCanBusPlugin_STATIC_DEBUG_LINK_FLAGS
    )
endif()
...
if(EXISTS "${_qt5SerialBus_install_prefix}/plugins/canbus/libqttinycanbus.a")
    _populate_SerialBus_plugin_properties(TinyCanBusPlugin RELEASE "canbus/libqttinycanbus.a" FALSE)
endif()
if(EXISTS "${_qt5SerialBus_install_prefix}/debug/plugins/canbus/libqttinycanbus.a")
    _populate_SerialBus_plugin_properties(TinyCanBusPlugin DEBUG "canbus/libqttinycanbus.a" FALSE)
endif()
