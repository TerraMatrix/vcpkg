...
if(EXISTS "${_qt5SerialBus_install_prefix}/plugins/canbus/libqtpassthrucanbus.prl")
...
if(EXISTS "${_qt5SerialBus_install_prefix}/debug/plugins/canbus/libqtpassthrucanbus.prl")
    _qt5_SerialBus_process_prl_file(
        "${_qt5SerialBus_install_prefix}/debug/plugins/canbus/libqtpassthrucanbus.prl" DEBUG
        _Qt5PassThruCanBusPlugin_STATIC_DEBUG_LIB_DEPENDENCIES
        _Qt5PassThruCanBusPlugin_STATIC_DEBUG_LINK_FLAGS
    )
endif()
...
if(EXISTS "${_qt5SerialBus_install_prefix}/plugins/canbus/libqtpassthrucanbus.a")
    _populate_SerialBus_plugin_properties(PassThruCanBusPlugin RELEASE "canbus/libqtpassthrucanbus.a" FALSE)
endif()
if(EXISTS "${_qt5SerialBus_install_prefix}/debug/plugins/canbus/libqtpassthrucanbus.a")
    _populate_SerialBus_plugin_properties(PassThruCanBusPlugin DEBUG "canbus/libqtpassthrucanbus.a" FALSE)
endif()
