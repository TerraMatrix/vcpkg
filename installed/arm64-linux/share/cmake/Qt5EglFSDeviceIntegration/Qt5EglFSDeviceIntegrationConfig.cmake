...
if (NOT TARGET Qt5::EglFSDeviceIntegration)
    ...
    if (EXISTS
        "${_qt5EglFSDeviceIntegration_install_prefix}/debug/lib/libQt5EglFSDeviceIntegration.so.5.15.17"
      AND EXISTS
        "${_qt5EglFSDeviceIntegration_install_prefix}/debug/lib/" )
        _populate_EglFSDeviceIntegration_target_properties(DEBUG "libQt5EglFSDeviceIntegration.so.5.15.17" "" FALSE)
    endif()
