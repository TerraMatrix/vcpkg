...
if(EXISTS "${_qt5Multimedia_install_prefix}/plugins/audio/libqtmedia_pulse.so")
    _populate_Multimedia_plugin_properties(QPulseAudioPlugin RELEASE "audio/libqtmedia_pulse.so" FALSE)
endif()
if(EXISTS "${_qt5Multimedia_install_prefix}/debug/plugins/audio/libqtmedia_pulse.so")
    _populate_Multimedia_plugin_properties(QPulseAudioPlugin DEBUG "audio/libqtmedia_pulse.so" FALSE)
endif()
