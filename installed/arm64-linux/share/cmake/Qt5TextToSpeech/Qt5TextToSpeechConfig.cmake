...
function(_qt5_TextToSpeech_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(_qt5_install_libs "${_qt5TextToSpeech_install_prefix}/debug/lib/")
    else()
...
macro(_populate_TextToSpeech_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG") # 1
        set(imported_location "${_qt5TextToSpeech_install_prefix}/debug/lib/${LIB_LOCATION}")
    else()
    ...
    if(_static_deps)
        ...
        #message(STATUS "Target Qt5::TextToSpeech static links: ${_static_dep} through ${_static_dep_genex}") # Added for debugging
    endif()
    ...
    if(_static_link_flags)
        ...
        if(NOT CMAKE_VERSION VERSION_LESS "3.13")
            ...
            #message(STATUS "Target Qt5::TextToSpeech static link flags: ${_static_link_flags} through ${_static_link_flags_genex}")
        endif()
    endif()
...
if (NOT TARGET Qt5::TextToSpeech)
    ...
    set(Qt5TextToSpeech_PRIVATE_INCLUDE_DIRS
        "${_qt5TextToSpeech_install_prefix}/include/qt5/QtTextToSpeech/5.15.17"
        "${_qt5TextToSpeech_install_prefix}/include/qt5/QtTextToSpeech/5.15.17/QtTextToSpeech"
    )
    ...
    if(EXISTS "${_qt5TextToSpeech_install_prefix}/debug/lib/libQt5TextToSpeech.prl")
        _qt5_TextToSpeech_process_prl_file(
            "${_qt5TextToSpeech_install_prefix}/debug/lib/libQt5TextToSpeech.prl" DEBUG
            _Qt5TextToSpeech_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5TextToSpeech_STATIC_DEBUG_LINK_FLAGS
        )
    endif()

    if(EXISTS "${_qt5TextToSpeech_install_prefix}/lib/libQt5TextToSpeech.prl")
        _qt5_TextToSpeech_process_prl_file(
    ...
    if (EXISTS
        "${_qt5TextToSpeech_install_prefix}/debug/lib/libQt5TextToSpeech.a"
      AND EXISTS
        "${_qt5TextToSpeech_install_prefix}/debug/lib/" )
        _populate_TextToSpeech_target_properties(DEBUG "libQt5TextToSpeech.a" "" FALSE)
    endif()
