...
if (NOT TARGET Qt5::TextToSpeech)
    ...
    if (EXISTS
        "${_qt5TextToSpeech_install_prefix}/debug/lib/libQt5TextToSpeech.so.5.15.17"
      AND EXISTS
        "${_qt5TextToSpeech_install_prefix}/debug/lib/" )
        _populate_TextToSpeech_target_properties(DEBUG "libQt5TextToSpeech.so.5.15.17" "" FALSE)
    endif()
