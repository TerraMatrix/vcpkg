...
set(Qt53DCore_VERSION_STRING 5.15.17)
...
function(_qt5_3DCore_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(_qt5_install_libs "${_qt53DCore_install_prefix}/debug/lib/")
    else()
...
macro(_populate_3DCore_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG") # 1
        set(imported_location "${_qt53DCore_install_prefix}/debug/lib/${LIB_LOCATION}")
    else()
    ...
    if(_static_deps)
        ...
        #message(STATUS "Target Qt5::3DCore static links: ${_static_dep} through ${_static_dep_genex}") # Added for debugging
    endif()
    ...
    if(_static_link_flags)
        ...
        if(NOT CMAKE_VERSION VERSION_LESS "3.13")
            ...
            #message(STATUS "Target Qt5::3DCore static link flags: ${_static_link_flags} through ${_static_link_flags_genex}")
        endif()
    endif()
...
if (NOT TARGET Qt5::3DCore)
    ...
    set(Qt53DCore_PRIVATE_INCLUDE_DIRS
        "${_qt53DCore_install_prefix}/include/qt5/Qt3DCore/5.15.17"
        "${_qt53DCore_install_prefix}/include/qt5/Qt3DCore/5.15.17/Qt3DCore"
    )
    ...
    foreach(_module_dep ${_Qt53DCore_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.17 ${_Qt53DCore_FIND_VERSION_EXACT}
    ...
    if(EXISTS "${_qt53DCore_install_prefix}/debug/lib/libQt53DCore.prl")
        _qt5_3DCore_process_prl_file(
            "${_qt53DCore_install_prefix}/debug/lib/libQt53DCore.prl" DEBUG
            _Qt53DCore_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt53DCore_STATIC_DEBUG_LINK_FLAGS
        )
    endif()

    if(EXISTS "${_qt53DCore_install_prefix}/lib/libQt53DCore.prl")
        _qt5_3DCore_process_prl_file(
    ...
    set_property(TARGET Qt5::3DCore
                 ...
                 assimp;system-assimp)
    set_property(TARGET Qt5::3DCore
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 qt3d-profile-gl;qt3d-profile-jobs;qt3d-simd-avx2;qt3d-simd-sse2)
    ...
    if (EXISTS
        "${_qt53DCore_install_prefix}/debug/lib/libQt53DCore.a"
      AND EXISTS
        "${_qt53DCore_install_prefix}/debug/lib/" )
        _populate_3DCore_target_properties(DEBUG "libQt53DCore.a" "" FALSE)
    endif()
