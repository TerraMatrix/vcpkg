...
if (NOT TARGET Qt5::Sql)
    ...
    set(Qt5Sql_PRIVATE_INCLUDE_DIRS
        "${_qt5Sql_install_prefix}/include/qt5/QtSql/5.15.17"
        "${_qt5Sql_install_prefix}/include/qt5/QtSql/5.15.17/QtSql"
    )
    ...
    if(EXISTS "${_qt5Sql_install_prefix}/debug/lib/libQt5Sql.prl")
        _qt5_Sql_process_prl_file(
            "${_qt5Sql_install_prefix}/debug/lib/libQt5Sql.prl" DEBUG
    ...
    if (EXISTS
        "${_qt5Sql_install_prefix}/debug/lib/libQt5Sql.a"
      AND EXISTS
