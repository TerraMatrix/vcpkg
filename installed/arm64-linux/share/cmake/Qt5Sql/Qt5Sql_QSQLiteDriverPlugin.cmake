...
if(EXISTS "${_qt5Sql_install_prefix}/plugins/sqldrivers/libqsqlite.so")
    _populate_Sql_plugin_properties(QSQLiteDriverPlugin RELEASE "sqldrivers/libqsqlite.so" FALSE)
endif()
if(EXISTS "${_qt5Sql_install_prefix}/debug/plugins/sqldrivers/libqsqlite.so")
    _populate_Sql_plugin_properties(QSQLiteDriverPlugin DEBUG "sqldrivers/libqsqlite.so" FALSE)
endif()
