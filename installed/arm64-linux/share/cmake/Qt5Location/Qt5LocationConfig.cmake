...
if (NOT TARGET Qt5::Location)
    ...
    _populate_Location_target_properties(RELEASE "libQt5Location.so.5.15.17" "" FALSE)

    if (EXISTS
        "${_qt5Location_install_prefix}/debug/lib/libQt5Location.so.5.15.17"
      AND EXISTS
        "${_qt5Location_install_prefix}/debug/lib/" )
        _populate_Location_target_properties(DEBUG "libQt5Location.so.5.15.17" "" FALSE)
    endif()
