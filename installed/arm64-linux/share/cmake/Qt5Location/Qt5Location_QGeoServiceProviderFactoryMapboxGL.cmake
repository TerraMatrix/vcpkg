...
set(_Qt5QGeoServiceProviderFactoryMapboxGL_MODULE_DEPENDENCIES "Location;Location;Positioning;Quick;Quick;Quick;Gui;Network;Sql;Core")
...
if(EXISTS "${_qt5Location_install_prefix}/plugins/geoservices/libqtgeoservices_mapboxgl.prl")
...
if(EXISTS "${_qt5Location_install_prefix}/debug/plugins/geoservices/libqtgeoservices_mapboxgl.prl")
    _qt5_Location_process_prl_file(
        "${_qt5Location_install_prefix}/debug/plugins/geoservices/libqtgeoservices_mapboxgl.prl" DEBUG
...
if(EXISTS "${_qt5Location_install_prefix}/plugins/geoservices/libqtgeoservices_mapboxgl.a")
...
if(EXISTS "${_qt5Location_install_prefix}/debug/plugins/geoservices/libqtgeoservices_mapboxgl.a")
    _populate_Location_plugin_properties(QGeoServiceProviderFactoryMapboxGL DEBUG "geoservices/libqtgeoservices_mapboxgl.a" FALSE)
endif()
...
set_property(TARGET Qt5::QGeoServiceProviderFactoryMapboxGL APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    "Qt5::Location;Qt5::Location;Qt5::Positioning;Qt5::Quick;Qt5::Quick;Qt5::Quick;Qt5::Gui;Qt5::Network;Qt5::Sql;Qt5::Core"
)
