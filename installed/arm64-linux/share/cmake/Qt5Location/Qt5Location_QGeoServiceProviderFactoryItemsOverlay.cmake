...
set(_Qt5QGeoServiceProviderFactoryItemsOverlay_MODULE_DEPENDENCIES "Location;Location;Positioning;Gui;Core")
...
if(EXISTS "${_qt5Location_install_prefix}/plugins/geoservices/libqtgeoservices_itemsoverlay.prl")
...
if(EXISTS "${_qt5Location_install_prefix}/debug/plugins/geoservices/libqtgeoservices_itemsoverlay.prl")
    _qt5_Location_process_prl_file(
        "${_qt5Location_install_prefix}/debug/plugins/geoservices/libqtgeoservices_itemsoverlay.prl" DEBUG
...
if(EXISTS "${_qt5Location_install_prefix}/plugins/geoservices/libqtgeoservices_itemsoverlay.a")
...
if(EXISTS "${_qt5Location_install_prefix}/debug/plugins/geoservices/libqtgeoservices_itemsoverlay.a")
    _populate_Location_plugin_properties(QGeoServiceProviderFactoryItemsOverlay DEBUG "geoservices/libqtgeoservices_itemsoverlay.a" FALSE)
endif()
...
set_property(TARGET Qt5::QGeoServiceProviderFactoryItemsOverlay APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    "Qt5::Location;Qt5::Location;Qt5::Positioning;Qt5::Gui;Qt5::Core"
)
