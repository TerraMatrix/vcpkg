...
set(_Qt5QGeoServiceProviderFactoryMapbox_MODULE_DEPENDENCIES "Location;Location;Positioning;Gui;Network;Core")
...
if(EXISTS "${_qt5Location_install_prefix}/plugins/geoservices/libqtgeoservices_mapbox.prl")
...
if(EXISTS "${_qt5Location_install_prefix}/debug/plugins/geoservices/libqtgeoservices_mapbox.prl")
    _qt5_Location_process_prl_file(
        "${_qt5Location_install_prefix}/debug/plugins/geoservices/libqtgeoservices_mapbox.prl" DEBUG
...
if(EXISTS "${_qt5Location_install_prefix}/plugins/geoservices/libqtgeoservices_mapbox.a")
...
if(EXISTS "${_qt5Location_install_prefix}/debug/plugins/geoservices/libqtgeoservices_mapbox.a")
    _populate_Location_plugin_properties(QGeoServiceProviderFactoryMapbox DEBUG "geoservices/libqtgeoservices_mapbox.a" FALSE)
endif()
...
set_property(TARGET Qt5::QGeoServiceProviderFactoryMapbox APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    "Qt5::Location;Qt5::Location;Qt5::Positioning;Qt5::Gui;Qt5::Network;Qt5::Core"
)
