...
set(_Qt5QGeoServiceProviderFactoryNokia_MODULE_DEPENDENCIES "Location;Location;Positioning;Location;Gui;Network;Core")
...
if(EXISTS "${_qt5Location_install_prefix}/plugins/geoservices/libqtgeoservices_nokia.prl")
...
if(EXISTS "${_qt5Location_install_prefix}/debug/plugins/geoservices/libqtgeoservices_nokia.prl")
    _qt5_Location_process_prl_file(
        "${_qt5Location_install_prefix}/debug/plugins/geoservices/libqtgeoservices_nokia.prl" DEBUG
...
if(EXISTS "${_qt5Location_install_prefix}/plugins/geoservices/libqtgeoservices_nokia.a")
    _populate_Location_plugin_properties(QGeoServiceProviderFactoryNokia RELEASE "geoservices/libqtgeoservices_nokia.a" FALSE)
endif()
if(EXISTS "${_qt5Location_install_prefix}/debug/plugins/geoservices/libqtgeoservices_nokia.a")
    _populate_Location_plugin_properties(QGeoServiceProviderFactoryNokia DEBUG "geoservices/libqtgeoservices_nokia.a" FALSE)
endif()
...
set_property(TARGET Qt5::QGeoServiceProviderFactoryNokia APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    "Qt5::Location;Qt5::Location;Qt5::Positioning;Qt5::Location;Qt5::Gui;Qt5::Network;Qt5::Core"
)
