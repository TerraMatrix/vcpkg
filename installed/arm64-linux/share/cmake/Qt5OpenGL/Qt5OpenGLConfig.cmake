...
if (NOT TARGET Qt5::OpenGL)
    ...
    set(Qt5OpenGL_PRIVATE_INCLUDE_DIRS
        "${_qt5OpenGL_install_prefix}/include/qt5/QtOpenGL/5.15.17"
        "${_qt5OpenGL_install_prefix}/include/qt5/QtOpenGL/5.15.17/QtOpenGL"
    )
    ...
    if(EXISTS "${_qt5OpenGL_install_prefix}/debug/lib/libQt5OpenGL.prl")
        _qt5_OpenGL_process_prl_file(
            "${_qt5OpenGL_install_prefix}/debug/lib/libQt5OpenGL.prl" DEBUG
    ...
    if (EXISTS
        "${_qt5OpenGL_install_prefix}/debug/lib/libQt5OpenGL.a"
      AND EXISTS
        "${_qt5OpenGL_install_prefix}/debug/lib/" )
        _populate_OpenGL_target_properties(DEBUG "libQt5OpenGL.a" "" FALSE)
    endif()
