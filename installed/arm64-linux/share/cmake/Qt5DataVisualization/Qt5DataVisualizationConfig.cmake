...
if (NOT TARGET Qt5::DataVisualization)
    ...
    if (EXISTS
        "${_qt5DataVisualization_install_prefix}/debug/lib/libQt5DataVisualization.so.5.15.17"
      AND EXISTS
        "${_qt5DataVisualization_install_prefix}/debug/lib/" )
        _populate_DataVisualization_target_properties(DEBUG "libQt5DataVisualization.so.5.15.17" "" FALSE)
    endif()
