...
if (NOT TARGET Qt5::QuickParticles)
    ...
    set(Qt5QuickParticles_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickParticles_install_prefix}/include/qt5/QtQuickParticles/5.15.17"
        "${_qt5QuickParticles_install_prefix}/include/qt5/QtQuickParticles/5.15.17/QtQuickParticles"
    )
    ...
    if(EXISTS "${_qt5QuickParticles_install_prefix}/debug/lib/libQt5QuickParticles.prl")
        _qt5_QuickParticles_process_prl_file(
            "${_qt5QuickParticles_install_prefix}/debug/lib/libQt5QuickParticles.prl" DEBUG
    ...
    if (EXISTS
        "${_qt5QuickParticles_install_prefix}/debug/lib/libQt5QuickParticles.a"
      AND EXISTS
        "${_qt5QuickParticles_install_prefix}/debug/lib/" )
        _populate_QuickParticles_target_properties(DEBUG "libQt5QuickParticles.a" "" FALSE)
    endif()
