...
if (NOT TARGET Qt5::QuickParticles)
    ...
    if (EXISTS
        "${_qt5QuickParticles_install_prefix}/debug/lib/libQt5QuickParticles.so.5.15.17"
      AND EXISTS
        "${_qt5QuickParticles_install_prefix}/debug/lib/" )
        _populate_QuickParticles_target_properties(DEBUG "libQt5QuickParticles.so.5.15.17" "" FALSE)
    endif()
