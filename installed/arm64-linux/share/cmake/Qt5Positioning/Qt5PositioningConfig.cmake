...
if (NOT TARGET Qt5::Positioning)
    ...
    _populate_Positioning_target_properties(RELEASE "libQt5Positioning.so.5.15.17" "" FALSE)

    if (EXISTS
        "${_qt5Positioning_install_prefix}/debug/lib/libQt5Positioning.so.5.15.17"
      AND EXISTS
        "${_qt5Positioning_install_prefix}/debug/lib/" )
        _populate_Positioning_target_properties(DEBUG "libQt5Positioning.so.5.15.17" "" FALSE)
    endif()
