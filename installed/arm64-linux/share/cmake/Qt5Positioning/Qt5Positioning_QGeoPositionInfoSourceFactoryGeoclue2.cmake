...
if(EXISTS "${_qt5Positioning_install_prefix}/plugins/position/libqtposition_geoclue2.prl")
...
if(EXISTS "${_qt5Positioning_install_prefix}/debug/plugins/position/libqtposition_geoclue2.prl")
    _qt5_Positioning_process_prl_file(
        "${_qt5Positioning_install_prefix}/debug/plugins/position/libqtposition_geoclue2.prl" DEBUG
        _Qt5QGeoPositionInfoSourceFactoryGeoclue2_STATIC_DEBUG_LIB_DEPENDENCIES
        _Qt5QGeoPositionInfoSourceFactoryGeoclue2_STATIC_DEBUG_LINK_FLAGS
    )
endif()
...
if(EXISTS "${_qt5Positioning_install_prefix}/plugins/position/libqtposition_geoclue2.a")
...
if(EXISTS "${_qt5Positioning_install_prefix}/debug/plugins/position/libqtposition_geoclue2.a")
    _populate_Positioning_plugin_properties(QGeoPositionInfoSourceFactoryGeoclue2 DEBUG "position/libqtposition_geoclue2.a" FALSE)
endif()
