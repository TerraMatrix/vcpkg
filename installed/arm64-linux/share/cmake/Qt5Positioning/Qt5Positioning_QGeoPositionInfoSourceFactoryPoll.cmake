...
if(EXISTS "${_qt5Positioning_install_prefix}/plugins/position/libqtposition_positionpoll.prl")
...
if(EXISTS "${_qt5Positioning_install_prefix}/debug/plugins/position/libqtposition_positionpoll.prl")
    _qt5_Positioning_process_prl_file(
        "${_qt5Positioning_install_prefix}/debug/plugins/position/libqtposition_positionpoll.prl" DEBUG
...
if(EXISTS "${_qt5Positioning_install_prefix}/plugins/position/libqtposition_positionpoll.a")
...
if(EXISTS "${_qt5Positioning_install_prefix}/debug/plugins/position/libqtposition_positionpoll.a")
    _populate_Positioning_plugin_properties(QGeoPositionInfoSourceFactoryPoll DEBUG "position/libqtposition_positionpoll.a" FALSE)
endif()
