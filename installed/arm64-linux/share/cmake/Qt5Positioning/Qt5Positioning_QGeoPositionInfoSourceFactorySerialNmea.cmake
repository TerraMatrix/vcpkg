...
if(EXISTS "${_qt5Positioning_install_prefix}/plugins/position/libqtposition_serialnmea.prl")
...
if(EXISTS "${_qt5Positioning_install_prefix}/debug/plugins/position/libqtposition_serialnmea.prl")
    _qt5_Positioning_process_prl_file(
        "${_qt5Positioning_install_prefix}/debug/plugins/position/libqtposition_serialnmea.prl" DEBUG
        _Qt5QGeoPositionInfoSourceFactorySerialNmea_STATIC_DEBUG_LIB_DEPENDENCIES
        _Qt5QGeoPositionInfoSourceFactorySerialNmea_STATIC_DEBUG_LINK_FLAGS
    )
endif()
...
if(EXISTS "${_qt5Positioning_install_prefix}/plugins/position/libqtposition_serialnmea.a")
...
if(EXISTS "${_qt5Positioning_install_prefix}/debug/plugins/position/libqtposition_serialnmea.a")
    _populate_Positioning_plugin_properties(QGeoPositionInfoSourceFactorySerialNmea DEBUG "position/libqtposition_serialnmea.a" FALSE)
endif()
