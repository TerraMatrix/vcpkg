...
if(EXISTS "${_qt5Network_install_prefix}/debug/plugins/bearer/libqgenericbearer.prl")
    _qt5_Network_process_prl_file(
        "${_qt5Network_install_prefix}/debug/plugins/bearer/libqgenericbearer.prl" DEBUG
...
if(EXISTS "${_qt5Network_install_prefix}/debug/plugins/bearer/libqgenericbearer.a")
    _populate_Network_plugin_properties(QGenericEnginePlugin DEBUG "bearer/libqgenericbearer.a" FALSE)
endif()
