...
if(EXISTS "${_qt5Network_install_prefix}/plugins/bearer/libqgenericbearer.so")
    _populate_Network_plugin_properties(QGenericEnginePlugin RELEASE "bearer/libqgenericbearer.so" FALSE)
endif()
if(EXISTS "${_qt5Network_install_prefix}/debug/plugins/bearer/libqgenericbearer.so")
    _populate_Network_plugin_properties(QGenericEnginePlugin DEBUG "bearer/libqgenericbearer.so" FALSE)
endif()
