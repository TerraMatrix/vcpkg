...
if (NOT TARGET Qt5::Network)
    ...
    set(Qt5Network_PRIVATE_INCLUDE_DIRS
        "${_qt5Network_install_prefix}/include/qt5/QtNetwork/5.15.17"
        "${_qt5Network_install_prefix}/include/qt5/QtNetwork/5.15.17/QtNetwork"
    )
    ...
    if(EXISTS "${_qt5Network_install_prefix}/debug/lib/libQt5Network.prl")
        _qt5_Network_process_prl_file(
            "${_qt5Network_install_prefix}/debug/lib/libQt5Network.prl" DEBUG
    ...
    if (EXISTS
        "${_qt5Network_install_prefix}/debug/lib/libQt5Network.a"
      AND EXISTS
