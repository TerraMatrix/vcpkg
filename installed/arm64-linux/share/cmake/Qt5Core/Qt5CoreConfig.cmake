...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/include/qt5/QtCore/5.15.17"
        "${_qt5Core_install_prefix}/include/qt5/QtCore/5.15.17/QtCore"
    )
    ...
    if(EXISTS "${_qt5Core_install_prefix}/debug/lib/libQt5Core.prl")
        _qt5_Core_process_prl_file(
            "${_qt5Core_install_prefix}/debug/lib/libQt5Core.prl" DEBUG
    ...
    set_property(TARGET Qt5::Core
                 ...
                 clock-gettime;datetimeparser;doubleconversion;futimens;getauxval;getentropy;glibc;posix-libiconv;hijricalendar;iconv;inotify;linkat;mimetype-database;system-pcre2;poll_ppoll;renameat2;sha3-fast;statx;system-doubleconversion)
    set_property(TARGET Qt5::Core
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 etw;futimes;glib;gnu-libiconv;icu;journald;lttng;poll_poll;poll_pollts;poll_select;slog2;syslog)
    ...
    if (EXISTS
        "${_qt5Core_install_prefix}/debug/lib/libQt5Core.a"
      AND EXISTS
