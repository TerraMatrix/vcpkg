...
if (NOT TARGET Qt5::3DQuickRender)
    ...
    _populate_3DQuickRender_target_properties(RELEASE "libQt53DQuickRender.so.5.15.17" "" FALSE)

    if (EXISTS
        "${_qt53DQuickRender_install_prefix}/debug/lib/libQt53DQuickRender.so.5.15.17"
      AND EXISTS
        "${_qt53DQuickRender_install_prefix}/debug/lib/" )
        _populate_3DQuickRender_target_properties(DEBUG "libQt53DQuickRender.so.5.15.17" "" FALSE)
    endif()
