...
if (NOT TARGET Qt5::MultimediaQuick)
    ...
    if (EXISTS
        "${_qt5MultimediaQuick_install_prefix}/debug/lib/libQt5MultimediaQuick.so.5.15.17"
      AND EXISTS
        "${_qt5MultimediaQuick_install_prefix}/debug/lib/" )
        _populate_MultimediaQuick_target_properties(DEBUG "libQt5MultimediaQuick.so.5.15.17" "" FALSE)
    endif()
