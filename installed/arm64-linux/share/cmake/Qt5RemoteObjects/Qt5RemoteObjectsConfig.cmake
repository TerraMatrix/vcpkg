...
function(_qt5_RemoteObjects_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(_qt5_install_libs "${_qt5RemoteObjects_install_prefix}/debug/lib/")
    else()
...
macro(_populate_RemoteObjects_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG") # 1
        set(imported_location "${_qt5RemoteObjects_install_prefix}/debug/lib/${LIB_LOCATION}")
    else()
    ...
    if(_static_deps)
        ...
        #message(STATUS "Target Qt5::RemoteObjects static links: ${_static_dep} through ${_static_dep_genex}") # Added for debugging
    endif()
    ...
    if(_static_link_flags)
        ...
        if(NOT CMAKE_VERSION VERSION_LESS "3.13")
            ...
            #message(STATUS "Target Qt5::RemoteObjects static link flags: ${_static_link_flags} through ${_static_link_flags_genex}")
        endif()
    endif()
...
if (NOT TARGET Qt5::RemoteObjects)
    ...
    set(_Qt5RemoteObjects_OWN_INCLUDE_DIRS "${_qt5RemoteObjects_install_prefix}/include/qt5/" "${_qt5RemoteObjects_install_prefix}/include/qt5/QtRemoteObjects")
    set(Qt5RemoteObjects_PRIVATE_INCLUDE_DIRS
        "${_qt5RemoteObjects_install_prefix}/include/qt5/QtRemoteObjects/5.15.17"
        "${_qt5RemoteObjects_install_prefix}/include/qt5/QtRemoteObjects/5.15.17/QtRemoteObjects"
    )
    ...
    if(EXISTS "${_qt5RemoteObjects_install_prefix}/debug/lib/libQt5RemoteObjects.prl")
        _qt5_RemoteObjects_process_prl_file(
            "${_qt5RemoteObjects_install_prefix}/debug/lib/libQt5RemoteObjects.prl" DEBUG
            _Qt5RemoteObjects_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5RemoteObjects_STATIC_DEBUG_LINK_FLAGS
        )
    endif()

    if(EXISTS "${_qt5RemoteObjects_install_prefix}/lib/libQt5RemoteObjects.prl")
        _qt5_RemoteObjects_process_prl_file(
    ...
    if (EXISTS
        "${_qt5RemoteObjects_install_prefix}/debug/lib/libQt5RemoteObjects.a"
      AND EXISTS
        "${_qt5RemoteObjects_install_prefix}/debug/lib/" )
    ...
    macro(_populate_RemoteObjects_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        if("${Configuration}" STREQUAL "DEBUG")
            set(imported_location "${_qt5RemoteObjects_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
        else()
