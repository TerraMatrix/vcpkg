...
if (NOT TARGET Qt5::RemoteObjects)
    ...
    if (EXISTS
        "${_qt5RemoteObjects_install_prefix}/debug/lib/libQt5RemoteObjects.so.5.15.17"
      AND EXISTS
        "${_qt5RemoteObjects_install_prefix}/debug/lib/" )
        _populate_RemoteObjects_target_properties(DEBUG "libQt5RemoteObjects.so.5.15.17" "" FALSE)
    endif()
