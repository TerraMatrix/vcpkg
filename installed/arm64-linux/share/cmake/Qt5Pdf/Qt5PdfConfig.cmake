...
set(Qt5Pdf_VERSION_STRING 5.15.17)
...
macro(_populate_Pdf_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG") # 1
        set(imported_location "${_qt5Pdf_install_prefix}/debug/lib/${LIB_LOCATION}")
    else()
...
if (NOT TARGET Qt5::Pdf)
    ...
    set(_Qt5Pdf_OWN_INCLUDE_DIRS "${_qt5Pdf_install_prefix}/include/qt5/" "${_qt5Pdf_install_prefix}/include/qt5/QtPdf")
    set(Qt5Pdf_PRIVATE_INCLUDE_DIRS
        "${_qt5Pdf_install_prefix}/include/qt5/QtPdf/5.15.17"
        "${_qt5Pdf_install_prefix}/include/qt5/QtPdf/5.15.17/QtPdf"
    )
    ...
    foreach(_module_dep ${_Qt5Pdf_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.17 ${_Qt5Pdf_FIND_VERSION_EXACT}
    ...
    _populate_Pdf_target_properties(RELEASE "libQt5Pdf.so.5.15.17" "" FALSE)

    if (EXISTS
        "${_qt5Pdf_install_prefix}/debug/lib/libQt5Pdf.so.5.15.17"
      AND EXISTS
        "${_qt5Pdf_install_prefix}/debug/lib/" )
        _populate_Pdf_target_properties(DEBUG "libQt5Pdf.so.5.15.17" "" FALSE)
    endif()
    ...
    macro(_populate_Pdf_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        if("${Configuration}" STREQUAL "DEBUG")
            set(imported_location "${_qt5Pdf_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
        else()
