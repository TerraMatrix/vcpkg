...
if (NOT TARGET Qt5::Quick)
    ...
    set(Qt5Quick_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick_install_prefix}/include/qt5/QtQuick/5.15.17"
        "${_qt5Quick_install_prefix}/include/qt5/QtQuick/5.15.17/QtQuick"
    )
    ...
    if(EXISTS "${_qt5Quick_install_prefix}/debug/lib/libQt5Quick.prl")
        _qt5_Quick_process_prl_file(
            "${_qt5Quick_install_prefix}/debug/lib/libQt5Quick.prl" DEBUG
    ...
    if (EXISTS
        "${_qt5Quick_install_prefix}/debug/lib/libQt5Quick.a"
      AND EXISTS
        "${_qt5Quick_install_prefix}/debug/lib/" )
        _populate_Quick_target_properties(DEBUG "libQt5Quick.a" "" FALSE)
    endif()
