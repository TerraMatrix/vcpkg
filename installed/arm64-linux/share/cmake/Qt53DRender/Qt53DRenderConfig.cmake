...
if (NOT TARGET Qt5::3DRender)
    ...
    _populate_3DRender_target_properties(RELEASE "libQt53DRender.so.5.15.17" "" FALSE)

    if (EXISTS
        "${_qt53DRender_install_prefix}/debug/lib/libQt53DRender.so.5.15.17"
      AND EXISTS
        "${_qt53DRender_install_prefix}/debug/lib/" )
        _populate_3DRender_target_properties(DEBUG "libQt53DRender.so.5.15.17" "" FALSE)
    endif()
