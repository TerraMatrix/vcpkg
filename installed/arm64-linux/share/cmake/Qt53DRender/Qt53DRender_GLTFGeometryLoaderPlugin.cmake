...
if(EXISTS "${_qt53DRender_install_prefix}/plugins/geometryloaders/libgltfgeometryloader.so")
    _populate_3DRender_plugin_properties(GLTFGeometryLoaderPlugin RELEASE "geometryloaders/libgltfgeometryloader.so" FALSE)
endif()
if(EXISTS "${_qt53DRender_install_prefix}/debug/plugins/geometryloaders/libgltfgeometryloader.so")
    _populate_3DRender_plugin_properties(GLTFGeometryLoaderPlugin DEBUG "geometryloaders/libgltfgeometryloader.so" FALSE)
endif()
