...
if(EXISTS "${_qt53DRender_install_prefix}/plugins/renderplugins/libscene2d.prl")
...
if(EXISTS "${_qt53DRender_install_prefix}/debug/plugins/renderplugins/libscene2d.prl")
    _qt5_3DRender_process_prl_file(
        "${_qt53DRender_install_prefix}/debug/plugins/renderplugins/libscene2d.prl" DEBUG
...
if(EXISTS "${_qt53DRender_install_prefix}/plugins/renderplugins/libscene2d.a")
    _populate_3DRender_plugin_properties(Scene2DPlugin RELEASE "renderplugins/libscene2d.a" FALSE)
endif()
if(EXISTS "${_qt53DRender_install_prefix}/debug/plugins/renderplugins/libscene2d.a")
    _populate_3DRender_plugin_properties(Scene2DPlugin DEBUG "renderplugins/libscene2d.a" FALSE)
endif()
