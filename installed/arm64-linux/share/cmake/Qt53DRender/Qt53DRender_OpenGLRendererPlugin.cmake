...
if(EXISTS "${_qt53DRender_install_prefix}/plugins/renderers/libopenglrenderer.prl")
...
if(EXISTS "${_qt53DRender_install_prefix}/debug/plugins/renderers/libopenglrenderer.prl")
    _qt5_3DRender_process_prl_file(
        "${_qt53DRender_install_prefix}/debug/plugins/renderers/libopenglrenderer.prl" DEBUG
...
if(EXISTS "${_qt53DRender_install_prefix}/plugins/renderers/libopenglrenderer.a")
    _populate_3DRender_plugin_properties(OpenGLRendererPlugin RELEASE "renderers/libopenglrenderer.a" FALSE)
endif()
if(EXISTS "${_qt53DRender_install_prefix}/debug/plugins/renderers/libopenglrenderer.a")
    _populate_3DRender_plugin_properties(OpenGLRendererPlugin DEBUG "renderers/libopenglrenderer.a" FALSE)
endif()
