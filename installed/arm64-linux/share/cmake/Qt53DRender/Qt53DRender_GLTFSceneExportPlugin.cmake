...
if(EXISTS "${_qt53DRender_install_prefix}/plugins/sceneparsers/libgltfsceneexport.so")
    _populate_3DRender_plugin_properties(GLTFSceneExportPlugin RELEASE "sceneparsers/libgltfsceneexport.so" FALSE)
endif()
if(EXISTS "${_qt53DRender_install_prefix}/debug/plugins/sceneparsers/libgltfsceneexport.so")
    _populate_3DRender_plugin_properties(GLTFSceneExportPlugin DEBUG "sceneparsers/libgltfsceneexport.so" FALSE)
endif()
