...
if(EXISTS "${_qt53DRender_install_prefix}/plugins/sceneparsers/libgltfsceneimport.prl")
...
if(EXISTS "${_qt53DRender_install_prefix}/debug/plugins/sceneparsers/libgltfsceneimport.prl")
    _qt5_3DRender_process_prl_file(
        "${_qt53DRender_install_prefix}/debug/plugins/sceneparsers/libgltfsceneimport.prl" DEBUG
...
if(EXISTS "${_qt53DRender_install_prefix}/plugins/sceneparsers/libgltfsceneimport.a")
    _populate_3DRender_plugin_properties(GLTFSceneImportPlugin RELEASE "sceneparsers/libgltfsceneimport.a" FALSE)
endif()
if(EXISTS "${_qt53DRender_install_prefix}/debug/plugins/sceneparsers/libgltfsceneimport.a")
    _populate_3DRender_plugin_properties(GLTFSceneImportPlugin DEBUG "sceneparsers/libgltfsceneimport.a" FALSE)
endif()
