...
set(_Qt5AssimpSceneImportPlugin_MODULE_DEPENDENCIES "3DRender;3DCore;3DExtras;3DAnimation;3DRender;3DCore;Gui;Core;Core")
...
if(EXISTS "${_qt53DRender_install_prefix}/plugins/sceneparsers/libassimpsceneimport.prl")
...
if(EXISTS "${_qt53DRender_install_prefix}/debug/plugins/sceneparsers/libassimpsceneimport.prl")
    _qt5_3DRender_process_prl_file(
        "${_qt53DRender_install_prefix}/debug/plugins/sceneparsers/libassimpsceneimport.prl" DEBUG
        _Qt5AssimpSceneImportPlugin_STATIC_DEBUG_LIB_DEPENDENCIES
        _Qt5AssimpSceneImportPlugin_STATIC_DEBUG_LINK_FLAGS
    )
endif()
...
if(EXISTS "${_qt53DRender_install_prefix}/plugins/sceneparsers/libassimpsceneimport.a")
    _populate_3DRender_plugin_properties(AssimpSceneImportPlugin RELEASE "sceneparsers/libassimpsceneimport.a" FALSE)
endif()
if(EXISTS "${_qt53DRender_install_prefix}/debug/plugins/sceneparsers/libassimpsceneimport.a")
    _populate_3DRender_plugin_properties(AssimpSceneImportPlugin DEBUG "sceneparsers/libassimpsceneimport.a" FALSE)
endif()
...
set_property(TARGET Qt5::AssimpSceneImportPlugin APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    "Qt5::3DRender;Qt5::3DCore;Qt5::3DExtras;Qt5::3DAnimation;Qt5::3DRender;Qt5::3DCore;Qt5::Gui;Qt5::Core;Qt5::Core"
)
