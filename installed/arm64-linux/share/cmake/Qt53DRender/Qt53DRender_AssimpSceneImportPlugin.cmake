...
if(EXISTS "${_qt53DRender_install_prefix}/plugins/sceneparsers/libassimpsceneimport.so")
    _populate_3DRender_plugin_properties(AssimpSceneImportPlugin RELEASE "sceneparsers/libassimpsceneimport.so" FALSE)
endif()
if(EXISTS "${_qt53DRender_install_prefix}/debug/plugins/sceneparsers/libassimpsceneimport.so")
    _populate_3DRender_plugin_properties(AssimpSceneImportPlugin DEBUG "sceneparsers/libassimpsceneimport.so" FALSE)
endif()
