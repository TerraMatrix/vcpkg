...
if (NOT TARGET Qt5::Test)
    ...
    set(Qt5Test_PRIVATE_INCLUDE_DIRS
        "${_qt5Test_install_prefix}/include/qt5/QtTest/5.15.17"
        "${_qt5Test_install_prefix}/include/qt5/QtTest/5.15.17/QtTest"
    )
    ...
    if(EXISTS "${_qt5Test_install_prefix}/debug/lib/libQt5Test.prl")
        _qt5_Test_process_prl_file(
            "${_qt5Test_install_prefix}/debug/lib/libQt5Test.prl" DEBUG
    ...
    if (EXISTS
        "${_qt5Test_install_prefix}/debug/lib/libQt5Test.a"
      AND EXISTS
