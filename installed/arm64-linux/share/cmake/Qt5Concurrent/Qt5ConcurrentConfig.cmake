...
if (NOT TARGET Qt5::Concurrent)
    ...
    if(EXISTS "${_qt5Concurrent_install_prefix}/debug/lib/libQt5Concurrent.prl")
        _qt5_Concurrent_process_prl_file(
            "${_qt5Concurrent_install_prefix}/debug/lib/libQt5Concurrent.prl" DEBUG
    ...
    if (EXISTS
        "${_qt5Concurrent_install_prefix}/debug/lib/libQt5Concurrent.a"
      AND EXISTS
