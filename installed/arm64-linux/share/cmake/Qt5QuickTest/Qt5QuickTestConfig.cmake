...
if (NOT TARGET Qt5::QuickTest)
    ...
    set(Qt5QuickTest_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTest_install_prefix}/include/qt5/QtQuickTest/5.15.17"
        "${_qt5QuickTest_install_prefix}/include/qt5/QtQuickTest/5.15.17/QtQuickTest"
    )
    ...
    if(EXISTS "${_qt5QuickTest_install_prefix}/debug/lib/libQt5QuickTest.prl")
        _qt5_QuickTest_process_prl_file(
            "${_qt5QuickTest_install_prefix}/debug/lib/libQt5QuickTest.prl" DEBUG
    ...
    if (EXISTS
        "${_qt5QuickTest_install_prefix}/debug/lib/libQt5QuickTest.a"
      AND EXISTS
        "${_qt5QuickTest_install_prefix}/debug/lib/" )
        _populate_QuickTest_target_properties(DEBUG "libQt5QuickTest.a" "" FALSE)
    endif()
