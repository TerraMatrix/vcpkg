...
if (NOT TARGET Qt5::3DExtras)
    ...
    _populate_3DExtras_target_properties(RELEASE "libQt53DExtras.so.5.15.17" "" FALSE)

    if (EXISTS
        "${_qt53DExtras_install_prefix}/debug/lib/libQt53DExtras.so.5.15.17"
      AND EXISTS
        "${_qt53DExtras_install_prefix}/debug/lib/" )
        _populate_3DExtras_target_properties(DEBUG "libQt53DExtras.so.5.15.17" "" FALSE)
    endif()
