...
if (NOT TARGET Qt5::SerialPort)
    ...
    set(Qt5SerialPort_PRIVATE_INCLUDE_DIRS
        "${_qt5SerialPort_install_prefix}/include/qt5/QtSerialPort/5.15.17"
        "${_qt5SerialPort_install_prefix}/include/qt5/QtSerialPort/5.15.17/QtSerialPort"
    )
    ...
    if(EXISTS "${_qt5SerialPort_install_prefix}/debug/lib/libQt5SerialPort.prl")
        _qt5_SerialPort_process_prl_file(
            "${_qt5SerialPort_install_prefix}/debug/lib/libQt5SerialPort.prl" DEBUG
    ...
    if (EXISTS
        "${_qt5SerialPort_install_prefix}/debug/lib/libQt5SerialPort.a"
      AND EXISTS
        "${_qt5SerialPort_install_prefix}/debug/lib/" )
        _populate_SerialPort_target_properties(DEBUG "libQt5SerialPort.a" "" FALSE)
    endif()
