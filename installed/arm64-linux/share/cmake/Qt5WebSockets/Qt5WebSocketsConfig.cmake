...
if (NOT TARGET Qt5::WebSockets)
    ...
    set(Qt5WebSockets_PRIVATE_INCLUDE_DIRS
        "${_qt5WebSockets_install_prefix}/include/qt5/QtWebSockets/5.15.17"
        "${_qt5WebSockets_install_prefix}/include/qt5/QtWebSockets/5.15.17/QtWebSockets"
    )
    ...
    if(EXISTS "${_qt5WebSockets_install_prefix}/debug/lib/libQt5WebSockets.prl")
        _qt5_WebSockets_process_prl_file(
            "${_qt5WebSockets_install_prefix}/debug/lib/libQt5WebSockets.prl" DEBUG
    ...
    if (EXISTS
        "${_qt5WebSockets_install_prefix}/debug/lib/libQt5WebSockets.a"
      AND EXISTS
        "${_qt5WebSockets_install_prefix}/debug/lib/" )
        _populate_WebSockets_target_properties(DEBUG "libQt5WebSockets.a" "" FALSE)
    endif()
