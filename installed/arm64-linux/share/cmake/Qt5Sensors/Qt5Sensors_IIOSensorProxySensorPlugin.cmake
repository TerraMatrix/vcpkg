...
if(EXISTS "${_qt5Sensors_install_prefix}/plugins/sensors/libqtsensors_iio-sensor-proxy.so")
    _populate_Sensors_plugin_properties(IIOSensorProxySensorPlugin RELEASE "sensors/libqtsensors_iio-sensor-proxy.so" FALSE)
endif()
if(EXISTS "${_qt5Sensors_install_prefix}/debug/plugins/sensors/libqtsensors_iio-sensor-proxy.so")
    _populate_Sensors_plugin_properties(IIOSensorProxySensorPlugin DEBUG "sensors/libqtsensors_iio-sensor-proxy.so" FALSE)
endif()
