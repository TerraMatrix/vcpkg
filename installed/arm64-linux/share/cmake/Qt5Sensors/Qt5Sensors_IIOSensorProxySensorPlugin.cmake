...
set(_Qt5IIOSensorProxySensorPlugin_MODULE_DEPENDENCIES "Sensors;DBus;Core")
...
if(EXISTS "${_qt5Sensors_install_prefix}/plugins/sensors/libqtsensors_iio-sensor-proxy.prl")
...
if(EXISTS "${_qt5Sensors_install_prefix}/debug/plugins/sensors/libqtsensors_iio-sensor-proxy.prl")
    _qt5_Sensors_process_prl_file(
        "${_qt5Sensors_install_prefix}/debug/plugins/sensors/libqtsensors_iio-sensor-proxy.prl" DEBUG
        _Qt5IIOSensorProxySensorPlugin_STATIC_DEBUG_LIB_DEPENDENCIES
        _Qt5IIOSensorProxySensorPlugin_STATIC_DEBUG_LINK_FLAGS
    )
endif()
...
if(EXISTS "${_qt5Sensors_install_prefix}/plugins/sensors/libqtsensors_iio-sensor-proxy.a")
    _populate_Sensors_plugin_properties(IIOSensorProxySensorPlugin RELEASE "sensors/libqtsensors_iio-sensor-proxy.a" FALSE)
endif()
if(EXISTS "${_qt5Sensors_install_prefix}/debug/plugins/sensors/libqtsensors_iio-sensor-proxy.a")
    _populate_Sensors_plugin_properties(IIOSensorProxySensorPlugin DEBUG "sensors/libqtsensors_iio-sensor-proxy.a" FALSE)
endif()
