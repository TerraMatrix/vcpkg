...
if(EXISTS "${_qt5Sensors_install_prefix}/plugins/sensors/libqtsensors_linuxsys.prl")
...
if(EXISTS "${_qt5Sensors_install_prefix}/debug/plugins/sensors/libqtsensors_linuxsys.prl")
    _qt5_Sensors_process_prl_file(
        "${_qt5Sensors_install_prefix}/debug/plugins/sensors/libqtsensors_linuxsys.prl" DEBUG
        _Qt5LinuxSensorPlugin_STATIC_DEBUG_LIB_DEPENDENCIES
        _Qt5LinuxSensorPlugin_STATIC_DEBUG_LINK_FLAGS
    )
endif()
...
if(EXISTS "${_qt5Sensors_install_prefix}/plugins/sensors/libqtsensors_linuxsys.a")
    _populate_Sensors_plugin_properties(LinuxSensorPlugin RELEASE "sensors/libqtsensors_linuxsys.a" FALSE)
endif()
if(EXISTS "${_qt5Sensors_install_prefix}/debug/plugins/sensors/libqtsensors_linuxsys.a")
    _populate_Sensors_plugin_properties(LinuxSensorPlugin DEBUG "sensors/libqtsensors_linuxsys.a" FALSE)
endif()
