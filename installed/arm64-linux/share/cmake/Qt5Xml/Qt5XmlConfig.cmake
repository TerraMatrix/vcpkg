...
if (NOT TARGET Qt5::Xml)
    ...
    set(Qt5Xml_PRIVATE_INCLUDE_DIRS
        "${_qt5Xml_install_prefix}/include/qt5/QtXml/5.15.17"
        "${_qt5Xml_install_prefix}/include/qt5/QtXml/5.15.17/QtXml"
    )
    ...
    if(EXISTS "${_qt5Xml_install_prefix}/debug/lib/libQt5Xml.prl")
        _qt5_Xml_process_prl_file(
            "${_qt5Xml_install_prefix}/debug/lib/libQt5Xml.prl" DEBUG
    ...
    if (EXISTS
        "${_qt5Xml_install_prefix}/debug/lib/libQt5Xml.a"
      AND EXISTS
