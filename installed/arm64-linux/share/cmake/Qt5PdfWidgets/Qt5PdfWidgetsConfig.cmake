...
set(Qt5PdfWidgets_VERSION_STRING 5.15.17)
...
macro(_populate_PdfWidgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG") # 1
        set(imported_location "${_qt5PdfWidgets_install_prefix}/debug/lib/${LIB_LOCATION}")
    else()
...
if (NOT TARGET Qt5::PdfWidgets)
    ...
    set(_Qt5PdfWidgets_OWN_INCLUDE_DIRS "${_qt5PdfWidgets_install_prefix}/include/qt5/" "${_qt5PdfWidgets_install_prefix}/include/qt5/QtPdfWidgets")
    set(Qt5PdfWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5PdfWidgets_install_prefix}/include/qt5/QtPdfWidgets/5.15.17"
        "${_qt5PdfWidgets_install_prefix}/include/qt5/QtPdfWidgets/5.15.17/QtPdfWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5PdfWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.17 ${_Qt5PdfWidgets_FIND_VERSION_EXACT}
    ...
    _populate_PdfWidgets_target_properties(RELEASE "libQt5PdfWidgets.so.5.15.17" "" FALSE)

    if (EXISTS
        "${_qt5PdfWidgets_install_prefix}/debug/lib/libQt5PdfWidgets.so.5.15.17"
      AND EXISTS
        "${_qt5PdfWidgets_install_prefix}/debug/lib/" )
        _populate_PdfWidgets_target_properties(DEBUG "libQt5PdfWidgets.so.5.15.17" "" FALSE)
    endif()
    ...
    macro(_populate_PdfWidgets_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        if("${Configuration}" STREQUAL "DEBUG")
            set(imported_location "${_qt5PdfWidgets_install_prefix}/debug/plugins/${PLUGIN_LOCATION}")
        else()
