...
if (NOT TARGET Qt5::QuickControls2)
    ...
    if (EXISTS
        "${_qt5QuickControls2_install_prefix}/debug/lib/libQt5QuickControls2.so.5.15.17"
      AND EXISTS
        "${_qt5QuickControls2_install_prefix}/debug/lib/" )
        _populate_QuickControls2_target_properties(DEBUG "libQt5QuickControls2.so.5.15.17" "" FALSE)
    endif()
