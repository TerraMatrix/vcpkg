...
if (NOT TARGET Qt5::QuickWidgets)
    ...
    if (EXISTS
        "${_qt5QuickWidgets_install_prefix}/debug/lib/libQt5QuickWidgets.so.5.15.17"
      AND EXISTS
        "${_qt5QuickWidgets_install_prefix}/debug/lib/" )
        _populate_QuickWidgets_target_properties(DEBUG "libQt5QuickWidgets.so.5.15.17" "" FALSE)
    endif()
