...
if (NOT TARGET Qt5::QuickWidgets)
    ...
    set(Qt5QuickWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickWidgets_install_prefix}/include/qt5/QtQuickWidgets/5.15.17"
        "${_qt5QuickWidgets_install_prefix}/include/qt5/QtQuickWidgets/5.15.17/QtQuickWidgets"
    )
    ...
    if(EXISTS "${_qt5QuickWidgets_install_prefix}/debug/lib/libQt5QuickWidgets.prl")
        _qt5_QuickWidgets_process_prl_file(
            "${_qt5QuickWidgets_install_prefix}/debug/lib/libQt5QuickWidgets.prl" DEBUG
    ...
    if (EXISTS
        "${_qt5QuickWidgets_install_prefix}/debug/lib/libQt5QuickWidgets.a"
      AND EXISTS
        "${_qt5QuickWidgets_install_prefix}/debug/lib/" )
        _populate_QuickWidgets_target_properties(DEBUG "libQt5QuickWidgets.a" "" FALSE)
    endif()
