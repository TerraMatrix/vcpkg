...
if (NOT TARGET Qt5::DesignerComponents)
    ...
    if (EXISTS
        "${_qt5DesignerComponents_install_prefix}/debug/lib/libQt5DesignerComponents.so.5.15.17"
      AND EXISTS
        "${_qt5DesignerComponents_install_prefix}/debug/lib/" )
        _populate_DesignerComponents_target_properties(DEBUG "libQt5DesignerComponents.so.5.15.17" "" FALSE)
    endif()
