...
if (NOT TARGET Qt5::3DLogic)
    ...
    _populate_3DLogic_target_properties(RELEASE "libQt53DLogic.so.5.15.17" "" FALSE)

    if (EXISTS
        "${_qt53DLogic_install_prefix}/debug/lib/libQt53DLogic.so.5.15.17"
      AND EXISTS
        "${_qt53DLogic_install_prefix}/debug/lib/" )
        _populate_3DLogic_target_properties(DEBUG "libQt53DLogic.so.5.15.17" "" FALSE)
    endif()
