...
set_target_properties(spatialindex PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libspatialindex.so.7.0.0"
  IMPORTED_SONAME_RELEASE "libspatialindex.so.7"
  )

list(APPEND _cmake_import_check_targets spatialindex )
list(APPEND _cmake_import_check_files_for_spatialindex "${_IMPORT_PREFIX}/lib/libspatialindex.so.7.0.0" )
...
set_target_properties(spatialindex_c PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libspatialindex_c.so.7.0.0"
  IMPORTED_SONAME_RELEASE "libspatialindex_c.so.7"
  )

list(APPEND _cmake_import_check_targets spatialindex_c )
list(APPEND _cmake_import_check_files_for_spatialindex_c "${_IMPORT_PREFIX}/lib/libspatialindex_c.so.7.0.0" )
