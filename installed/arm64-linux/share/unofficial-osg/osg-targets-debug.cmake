...
set_target_properties(unofficial::osg::OpenThreads PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libOpenThreadsd.so.3.3.1"
  IMPORTED_SONAME_DEBUG "libOpenThreadsd.so.21"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::OpenThreads )
list(APPEND _cmake_import_check_files_for_unofficial::osg::OpenThreads "${_IMPORT_PREFIX}/debug/lib/libOpenThreadsd.so.3.3.1" )
...
set_target_properties(unofficial::osg::osg PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libosgd.so.3.6.5"
  IMPORTED_SONAME_DEBUG "libosgd.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osg )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osg "${_IMPORT_PREFIX}/debug/lib/libosgd.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgDB PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libosgDBd.so.3.6.5"
  IMPORTED_SONAME_DEBUG "libosgDBd.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgDB )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgDB "${_IMPORT_PREFIX}/debug/lib/libosgDBd.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgUtil PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libosgUtild.so.3.6.5"
  IMPORTED_SONAME_DEBUG "libosgUtild.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgUtil )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgUtil "${_IMPORT_PREFIX}/debug/lib/libosgUtild.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgGA PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libosgGAd.so.3.6.5"
  IMPORTED_SONAME_DEBUG "libosgGAd.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgGA )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgGA "${_IMPORT_PREFIX}/debug/lib/libosgGAd.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgText PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libosgTextd.so.3.6.5"
  IMPORTED_SONAME_DEBUG "libosgTextd.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgText )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgText "${_IMPORT_PREFIX}/debug/lib/libosgTextd.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgViewer PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libosgViewerd.so.3.6.5"
  IMPORTED_SONAME_DEBUG "libosgViewerd.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgViewer )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgViewer "${_IMPORT_PREFIX}/debug/lib/libosgViewerd.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgAnimation PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libosgAnimationd.so.3.6.5"
  IMPORTED_SONAME_DEBUG "libosgAnimationd.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgAnimation )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgAnimation "${_IMPORT_PREFIX}/debug/lib/libosgAnimationd.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgFX PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libosgFXd.so.3.6.5"
  IMPORTED_SONAME_DEBUG "libosgFXd.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgFX )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgFX "${_IMPORT_PREFIX}/debug/lib/libosgFXd.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgManipulator PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libosgManipulatord.so.3.6.5"
  IMPORTED_SONAME_DEBUG "libosgManipulatord.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgManipulator )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgManipulator "${_IMPORT_PREFIX}/debug/lib/libosgManipulatord.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgParticle PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "unofficial::osg::osgUtil;unofficial::osg::osgDB;unofficial::osg::osg;unofficial::osg::OpenThreads;/usr/lib/aarch64-linux-gnu/libGL.so"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libosgParticled.so.3.6.5"
  IMPORTED_SONAME_DEBUG "libosgParticled.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgParticle )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgParticle "${_IMPORT_PREFIX}/debug/lib/libosgParticled.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgUI PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libosgUId.so.3.6.5"
  IMPORTED_SONAME_DEBUG "libosgUId.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgUI )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgUI "${_IMPORT_PREFIX}/debug/lib/libosgUId.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgVolume PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libosgVolumed.so.3.6.5"
  IMPORTED_SONAME_DEBUG "libosgVolumed.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgVolume )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgVolume "${_IMPORT_PREFIX}/debug/lib/libosgVolumed.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgShadow PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "unofficial::osg::osgUtil;unofficial::osg::osgDB;unofficial::osg::osg;unofficial::osg::OpenThreads;/usr/lib/aarch64-linux-gnu/libGL.so"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libosgShadowd.so.3.6.5"
  IMPORTED_SONAME_DEBUG "libosgShadowd.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgShadow )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgShadow "${_IMPORT_PREFIX}/debug/lib/libosgShadowd.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgSim PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libosgSimd.so.3.6.5"
  IMPORTED_SONAME_DEBUG "libosgSimd.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgSim )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgSim "${_IMPORT_PREFIX}/debug/lib/libosgSimd.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgTerrain PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "unofficial::osg::osgUtil;unofficial::osg::osgDB;unofficial::osg::osg;unofficial::osg::OpenThreads;/usr/lib/aarch64-linux-gnu/libGL.so"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libosgTerraind.so.3.6.5"
  IMPORTED_SONAME_DEBUG "libosgTerraind.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgTerrain )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgTerrain "${_IMPORT_PREFIX}/debug/lib/libosgTerraind.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgWidget PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libosgWidgetd.so.3.6.5"
  IMPORTED_SONAME_DEBUG "libosgWidgetd.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgWidget )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgWidget "${_IMPORT_PREFIX}/debug/lib/libosgWidgetd.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgPresentation PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/libosgPresentationd.so.3.6.5"
  IMPORTED_SONAME_DEBUG "libosgPresentationd.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgPresentation )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgPresentation "${_IMPORT_PREFIX}/debug/lib/libosgPresentationd.so.3.6.5" )
