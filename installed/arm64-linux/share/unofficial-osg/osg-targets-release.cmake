...
set_target_properties(unofficial::osg::OpenThreads PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libOpenThreads.so.3.3.1"
  IMPORTED_SONAME_RELEASE "libOpenThreads.so.21"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::OpenThreads )
list(APPEND _cmake_import_check_files_for_unofficial::osg::OpenThreads "${_IMPORT_PREFIX}/lib/libOpenThreads.so.3.3.1" )
...
set_target_properties(unofficial::osg::osg PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libosg.so.3.6.5"
  IMPORTED_SONAME_RELEASE "libosg.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osg )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osg "${_IMPORT_PREFIX}/lib/libosg.so.3.6.5" )
...
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgDB "${_IMPORT_PREFIX}/lib/libosgDB.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgUtil PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libosgUtil.so.3.6.5"
  IMPORTED_SONAME_RELEASE "libosgUtil.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgUtil )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgUtil "${_IMPORT_PREFIX}/lib/libosgUtil.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgGA PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libosgGA.so.3.6.5"
  IMPORTED_SONAME_RELEASE "libosgGA.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgGA )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgGA "${_IMPORT_PREFIX}/lib/libosgGA.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgText PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libosgText.so.3.6.5"
  IMPORTED_SONAME_RELEASE "libosgText.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgText )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgText "${_IMPORT_PREFIX}/lib/libosgText.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgViewer PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libosgViewer.so.3.6.5"
  IMPORTED_SONAME_RELEASE "libosgViewer.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgViewer )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgViewer "${_IMPORT_PREFIX}/lib/libosgViewer.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgAnimation PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libosgAnimation.so.3.6.5"
  IMPORTED_SONAME_RELEASE "libosgAnimation.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgAnimation )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgAnimation "${_IMPORT_PREFIX}/lib/libosgAnimation.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgFX PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libosgFX.so.3.6.5"
  IMPORTED_SONAME_RELEASE "libosgFX.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgFX )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgFX "${_IMPORT_PREFIX}/lib/libosgFX.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgManipulator PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libosgManipulator.so.3.6.5"
  IMPORTED_SONAME_RELEASE "libosgManipulator.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgManipulator )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgManipulator "${_IMPORT_PREFIX}/lib/libosgManipulator.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgParticle PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "unofficial::osg::osgUtil;unofficial::osg::osgDB;unofficial::osg::osg;unofficial::osg::OpenThreads;/usr/lib/aarch64-linux-gnu/libGL.so"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libosgParticle.so.3.6.5"
  IMPORTED_SONAME_RELEASE "libosgParticle.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgParticle )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgParticle "${_IMPORT_PREFIX}/lib/libosgParticle.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgUI PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libosgUI.so.3.6.5"
  IMPORTED_SONAME_RELEASE "libosgUI.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgUI )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgUI "${_IMPORT_PREFIX}/lib/libosgUI.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgVolume PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libosgVolume.so.3.6.5"
  IMPORTED_SONAME_RELEASE "libosgVolume.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgVolume )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgVolume "${_IMPORT_PREFIX}/lib/libosgVolume.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgShadow PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "unofficial::osg::osgUtil;unofficial::osg::osgDB;unofficial::osg::osg;unofficial::osg::OpenThreads;/usr/lib/aarch64-linux-gnu/libGL.so"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libosgShadow.so.3.6.5"
  IMPORTED_SONAME_RELEASE "libosgShadow.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgShadow )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgShadow "${_IMPORT_PREFIX}/lib/libosgShadow.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgSim PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libosgSim.so.3.6.5"
  IMPORTED_SONAME_RELEASE "libosgSim.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgSim )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgSim "${_IMPORT_PREFIX}/lib/libosgSim.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgTerrain PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "unofficial::osg::osgUtil;unofficial::osg::osgDB;unofficial::osg::osg;unofficial::osg::OpenThreads;/usr/lib/aarch64-linux-gnu/libGL.so"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libosgTerrain.so.3.6.5"
  IMPORTED_SONAME_RELEASE "libosgTerrain.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgTerrain )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgTerrain "${_IMPORT_PREFIX}/lib/libosgTerrain.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgWidget PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libosgWidget.so.3.6.5"
  IMPORTED_SONAME_RELEASE "libosgWidget.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgWidget )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgWidget "${_IMPORT_PREFIX}/lib/libosgWidget.so.3.6.5" )
...
set_target_properties(unofficial::osg::osgPresentation PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libosgPresentation.so.3.6.5"
  IMPORTED_SONAME_RELEASE "libosgPresentation.so.161"
  )

list(APPEND _cmake_import_check_targets unofficial::osg::osgPresentation )
list(APPEND _cmake_import_check_files_for_unofficial::osg::osgPresentation "${_IMPORT_PREFIX}/lib/libosgPresentation.so.3.6.5" )
