...
function(z_vcpkg_qmake_fix_prl PACKAGE_DIR PRL_FILES)
        ...
        file(TO_CMAKE_PATH "${PACKAGE_DIR}/include/QT_VER" CMAKE_INCLUDE_PATH_TOUPPER_QT_VER)
        ...
        foreach(PRL_FILE IN LISTS PRL_FILES)
            ...
            string(REPLACE "${CMAKE_INCLUDE_PATH_TOUPPER_QT_VER}" "\$\$[QT_INSTALL_HEADERS]" _contents "${_contents}")
