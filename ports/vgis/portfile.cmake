...
if("ltr" IN_LIST FEATURES)
    ...
    set(QGIS_SHA512 7b2f2baaea40d6d9ed9ad0f50e796790bb534da1b8d467d3f372117d50d7969ab01276a82e7b86d3e9e20dc4665ee661e8d62562564ab01856629c337ab29460)
else()
    set(QGIS_REF master)
...
if("server" IN_LIST FEATURES)
    ...
    if("bindings" IN_LIST FEATURES)
        list(APPEND QGIS_OPTIONS_DEBUG -DWITH_SERVER_PLUGINS:BOOL=OFF)
        list(APPEND QGIS_OPTIONS_RELEASE -DWITH_SERVER_PLUGINS:BOOL=ON)
    else()
...
if(VCPKG_TARGET_IS_WINDOWS)
    ...
    list(APPEND QGIS_OPTIONS_RELEASE -DPython_EXECUTABLE:FILEPATH=${PYTHON_EXECUTABLE})
