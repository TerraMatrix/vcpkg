...
if("ltr" IN_LIST FEATURES)
    set(QGIS_REF final-3_16_8)
    set(QGIS_SHA512 baf79d7e241389de39b37269e02acbe335e029d25e97fad86164a36e5098548c5214337cc6a48f504fe926a673c58299ccca4c8fa24cb2a477d777da7b1e008a)
else()
    set(QGIS_REF final-3_20_0)
...
if(VCPKG_TARGET_IS_WINDOWS)
    ...
    if(NOT EXISTS "${PYTHON3_PATH}/Scripts/pyuic5.exe")
        ...
        vcpkg_execute_required_process(
            COMMAND "${PYTHON_EXECUTABLE}" -m pip install PyQt5==${QT_VERSION} PyQt5-sip QScintilla==${QSCINTILLA_VERSION} PyQt3D==${QT_VERSION} PyQtWebEngine==${QT_VERSION} ${PIP_MIRRORS}
            WORKING_DIRECTORY ${PYTHON3_PATH}
            LOGNAME pip
        )
